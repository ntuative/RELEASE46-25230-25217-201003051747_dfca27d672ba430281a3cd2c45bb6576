package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_491 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_729))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_729,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_94 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_729,"EOF"));
            }
         }
      }
      ...
      {
         if(var_491.parse(param1))
         {
            var_45.push(var_491);
            if(false)
            {
               var_133["null"] = var_491;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1344,var_491));
            var_491 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_45 != null && var_133 != null && param1 < var_45.length)
         {
