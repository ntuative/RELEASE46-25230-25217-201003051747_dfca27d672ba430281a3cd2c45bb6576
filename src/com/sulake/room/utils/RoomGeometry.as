package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_651:Number = 64;
      
      public static const const_887:Number = 32;
      ...
      private var var_1463:Number = 1;
      
      private var var_2336:Number = 500;
      
      private var var_1465:Number = 1;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_83 = new Vector3d();
         var_997 = new Vector3d();
         var_1464 = 1;
         var_1465 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1463 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_391 != param1 * var_1463)
         {
            var_391 = param1 * var_1463;
            ++var_78;
         }
      }
      ...
      {
         if(var_393 != param1 * var_1464)
         {
            var_393 = param1 * var_1464;
            ++var_78;
         }
      }
      ...
      {
         if(var_394 != param1 * var_1465)
         {
            var_394 = param1 * var_1465;
            ++var_78;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_392 != null)
         {
            ...
            var_392.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_392.add(_loc3_,_loc4_);
            ++var_78;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_997.assign(_loc22_);
         }
         else
         {
            var_997.assign(_loc17_);
         }
         ++var_78;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_394;
         _loc2_.z *= var_391;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_997);
         if(_loc3_ < var_2337 || _loc3_ > var_2336)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_394;
            _loc2_.z *= var_391;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_997);
         }
      ...
      {
         return new Vector3d(0 * var_393,0 * var_394,0 * var_391);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_392 != null)
         {
            ...
            return var_392.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_393,0 * var_394,0 * var_391);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_83;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_393,param2.y * var_394,param2.z * var_391);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_393,param3.y * var_394,param3.z * var_391);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_393,param4.y * var_394,param4.z * var_391);
