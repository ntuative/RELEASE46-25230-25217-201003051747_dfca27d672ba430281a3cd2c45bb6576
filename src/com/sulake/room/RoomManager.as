package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_498:IRoomObjectFactory = null;
      
      private var var_1526:int;
      
      private var var_2373:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_499 = [];
         var_500 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_289,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_458,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_700,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(var_34 == const_1284)
         {
            if(var_876 != null)
            {
               return false;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = var_412.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = var_412.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = var_498.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_498 = param2 as IRoomObjectFactory;
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_498 != null)
         {
            return var_498.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_43.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = var_499.indexOf(param1);
            if(_loc2_ >= 0)
            {
               var_499.splice(_loc2_,1);
            }
            if(false)
            {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = var_412.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = var_412.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_498.createRoomObjectLogic(_loc18_);
