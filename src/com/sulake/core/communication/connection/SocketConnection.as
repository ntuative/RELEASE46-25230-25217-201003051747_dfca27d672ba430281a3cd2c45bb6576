package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1298:int = 10000;
      ...
      private var var_652:IEncryption;
      ...
      private var var_334:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         var_77 = new Socket();
         var_332 = new Timer(const_1298,1);
         var_332.addEventListener(TimerEvent.TIMER,onTimeOutTimer);
      ...
      {
         var_332.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - var_653));
      ...
      {
         var_332.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - var_653));
      ...
      {
         var_332.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - var_653));
         dispatchEvent(param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         if(var_334)
         {
            var_334.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(var_652 != null)
         {
            _loc3_ = var_652.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(var_334)
         {
            var_334.connectionInit(param1,param2);
         }
      ...
      {
         var_292.addConnectionMessageEvent(_id,param1);
      }
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_333.writeByte(var_77.readUnsignedByte());
         }
      }
      ...
      {
         var_332.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - var_653));
         dispatchEvent(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_555.getMessages(var_333,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            if(var_334)
            {
               var_334.messageReceived(String(_loc5_),_loc6_.toString());
            }
            _loc7_ = var_784.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
            for each(_loc9_ in _loc7_)
            {
               _loc13_ = var_292.getMessageEvents(this,_loc9_);
            ...
            for each(_loc12_ in _loc8_)
            {
               ...
               if(_loc14_ != null)
               {
                  ...
                  if(_loc14_ != _loc11_)
                  {
                     ...
                     _loc10_ = var_292.getMessageParser(_loc14_);
                     if(_loc10_.flush())
                     {
      ...
      {
         var_332.delay = param1;
      }
      
      private function onIOError(param1:IOErrorEvent) : void
      {
         var_332.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - var_653));
         switch(param1.type)
         {
      ...
      {
         var_332.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - var_653));
         dispatchEvent(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_652 + "\n");
      }
   }
}
