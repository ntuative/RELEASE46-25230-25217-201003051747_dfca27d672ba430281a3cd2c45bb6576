package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      private var var_1249:IConnectionStateListener;
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc5_:Array = var_694[_loc3_];
      ...
      {
         var _loc3_:Array = var_694[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            var_694[param1] = _loc3_;
         }
         _loc3_.push(param2);
      }
      ...
      {
         var _loc2_:Class = var_693[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_844:
               _loc3_ = new SocketConnection(param1,this,var_1249);
               break;
            default:
