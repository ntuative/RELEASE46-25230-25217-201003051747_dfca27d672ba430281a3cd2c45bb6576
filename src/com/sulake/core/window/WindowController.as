package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         _children = new Array();
         var_313 = new Rectangle();
         if(_loc12_ != null)
         {
            var_360 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_54 = var_360.clone();
            var_5 = var_360.clone();
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_126,WindowParam.const_134);
         var _loc2_:* = !testParamFlag(WindowParam.const_118,WindowParam.const_148);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_5.clone();
            if(_loc1_)
            ...
            if(_loc2_)
            {
               ...
               else if(_loc5_ == WindowParam.const_287)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         var_743 = param1;
         var_611 = !!var_743 ? uint(var_611 | var_1360) : uint(var_611 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2207 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1220:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1154:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_935:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_364:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_969:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_614:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_709:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_215:
               _loc2_ = "null";
               break;
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_16)
         {
            var_16 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_606,var_5);
      ...
      {
         var_421 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_5,WindowRedrawFlag.const_917);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1079 || _loc3_.hasGraphicsContext())
         {
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_748);
      }
      
      public function set color(param1:uint) : void
      {
         var_1360 = param1 & 4278190080;
         var_611 = !!var_743 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_5,WindowRedrawFlag.const_71);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_726))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_800;
                  ...
                  if((var_14 & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_254))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_208:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_398,this,null));
                     if(testParamFlag(WindowParam.const_162,WindowParam.const_134))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_159,WindowParam.const_148))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_6 != null)
                     {
                        ...
                        var_14 = _loc8_;
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_262,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_402:
                  _context.invalidate(this,var_5.union(var_54),WindowRedrawFlag.const_353);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_853,this,null));
                     if(var_6 != null)
                     {
               ...
               case WindowNotifyEvent.const_297:
                  if(param1 == this)
                  {
                     ...
                     if(var_6 != null)
                     {
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_215,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_432:
                  _context.invalidate(this,var_5,WindowRedrawFlag.const_963);
                  break;
               case WindowNotifyEvent.const_395:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_460:
                  if(!(var_14 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_5,WindowRedrawFlag.const_353);
                     }
                  }
                  else if(var_14 & 0)
                  {
               ...
               case WindowNotifyEvent.const_215:
                  ...
                  break;
               case WindowNotifyEvent.const_398:
                  var_6.getRegionProperties(null,var_313);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_334:
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_814;
         update(this,_loc1_);
         return true;
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_748);
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_626,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_527;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1079 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            var_34 = param1;
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_432,this,null));
         }
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_805,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_689,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_402,this,null));
            }
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_208,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1335,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         if(var_162 && var_748 > 0)
         {
            if(!testParamFlag(WindowParam.const_30))
            {
               if(param1.x <= var_5.width && param1.y <= var_5.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1567,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1567,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1358,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_59,false);
         _loc1_.type = WindowNotifyEvent.const_1208;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_6 != param1)
         {
            ...
            if(var_6 != null)
            {
               var_313 = var_6.rectangle.clone();
               var_54.x = var_5.x;
               var_54.y = var_5.y;
               var_54.width = var_5.width;
               var_54.height = var_5.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_409,this,var_6));
            }
            else
            {
               var_313.x = 0;
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_81,var_14,_context,var_5,null,var_617,properties,var_612.concat(),_id) as WindowController;
         _loc2_.var_748 = var_748;
         _loc2_.var_162 = var_162;
         _loc2_._debug = _debug;
         _loc2_.var_313 = var_313.clone();
         _loc2_.var_5 = var_5.clone();
         _loc2_.var_360 = var_360.clone();
         ...
         _loc2_.var_611 = var_611;
         _loc2_.var_1360 = var_1360;
         _loc2_.var_1095 = var_1095;
         ...
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_314;
         _loc2_.background = var_743;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_614;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_366;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      public function method_8(param1:uint, param2:Array, param3:Boolean = false) : uint
      {
         var _loc4_:* = null;
         var _loc5_:* = 0;
         for each(_loc4_ in _children)
         {
            ...
            if(param3)
            {
               _loc5_ += _loc4_.method_8(param1,param2,param3);
            }
         }
         return _loc5_;
      }
      ...
      {
         var_748 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function close() : Boolean
      {
         ...
         visible = false;
         _loc1_.type = WindowNotifyEvent.const_791;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         if(var_34 == WindowState.const_378)
         {
            return true;
         }
         var_34 = WindowState.const_378;
