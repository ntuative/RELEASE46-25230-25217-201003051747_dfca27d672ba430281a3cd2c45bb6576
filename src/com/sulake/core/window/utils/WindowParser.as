package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1479:String = "_INCLUDE";
      
      public static const const_837:String = "_EXCLUDE";
      
      public static const const_1433:String = "_TEMP";
      
      private static const const_1039:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1040:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1362:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1361:Dictionary;
      
      protected var var_1096:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1096,var_1097);
         var_923 = new Dictionary();
         var_1361 = new Dictionary();
         ParamCodeTable.fillTables(var_923,var_1361);
         var_1362 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1040,"");
         return param1.replace(const_1039,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1096)
            {
               delete var_1096[_loc1_];
            }
            ...
            for(_loc1_ in var_1361)
            {
               delete var_1361[_loc1_];
            }
            var_1362.dispose();
            var_1362 = null;
            _context = null;
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_162)
                     {
                        window.x = rect.x;
                     }
