package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_913:uint = 256;
      
      protected static var var_620:uint = 0;
      
      protected static var var_366:uint = 0;
      
      public static const const_824:uint = 2;
      
      public static const const_1482:uint = 128;
      
      public static const const_1513:uint = 64;
      
      public static const const_701:uint = 4;
      
      public static const const_1235:uint = 0;
      
      public static const const_1322:uint = 16;
      
      public static const const_606:uint = 1;
      
      public static const const_1226:uint = 8;
       
      
      protected var _disposed:Boolean = false;
      
      protected var var_616:Boolean;
      
      protected var var_1588:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_824:
               ...
               break;
            case GraphicContext.const_1226:
               setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1322:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_701:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_913:
               break;
            case GraphicContext.const_1235:
               break;
            default:
         ...
         if(var_616)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1588,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1588,16777215);
                  }
                  var_366 += bitmap.width * bitmap.height * 4;
               }
