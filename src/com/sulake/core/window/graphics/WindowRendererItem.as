package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_758:uint = 1;
      
      private static const const_757:uint = 2;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_963:
               var_686 = var_687.getTheActualState(param1.type,param1.style,param1.state);
               if(var_686 != var_1012)
               {
                  var_229 = true;
                  _loc4_ = true;
            ...
            case WindowRedrawFlag.const_917:
               ...
               break;
            case WindowRedrawFlag.const_231:
               _loc4_ = true;
         }
         if(_loc4_)
         {
      ...
      {
         return var_687.getTheActualState(param1.type,param1.style,param1.state) != var_1012;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc10_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_757) : uint(const_492);
         var _loc6_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc6_ != null)
         {
            _loc5_ = !!_loc6_.isStateDrawable(var_686) ? uint(const_758) : uint(_loc5_);
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_758)
               {
                  ...
                  if(var_229)
                  {
                     ...
                     _loc6_.draw(param1,var_93,var_93.rect,var_686,false);
                  ...
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_30))
                  {
                     ...
                     _loc4_.draw(var_93,var_927,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      private function resolveSkinRenderer(param1:IWindow) : ISkinRenderer
      {
         ...
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_972)
            {
               _loc2_ = var_687.getSkinRendererByType(param1.type,WindowStyle.const_972);
            }
         }
         return _loc2_;
      }
