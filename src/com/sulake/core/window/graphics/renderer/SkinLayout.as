package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinLayout extends ChildEntityArray implements ISkinLayout
   {
      ...
      protected var var_930:IChildEntityArray;
      ...
      public function getDefaultRegion(param1:String, param2:Rectangle) : void
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = var_930.getChildByName(param1) as ISkinLayoutEntity;
            if(_loc3_ == null)
            {
      ...
      public function dispose() : void
      {
         ...
         for(_loc3_ in var_930)
         {
            ISkinLayoutEntity(var_930[_loc3_]).dispose();
            delete var_930[_loc3_];
         }
      }
