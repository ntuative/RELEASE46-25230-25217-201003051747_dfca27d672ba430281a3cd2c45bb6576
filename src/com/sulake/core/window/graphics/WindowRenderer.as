package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1554:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_602 = new Array();
         var_1553 = new Point();
         var_1554 = new Rectangle();
         var_312 = new Rectangle();
         var_311 = new Dictionary(true);
         var_687 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_311[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            if(!_loc1_.disposed)
            {
               ...
               var_312.x = _loc3_.dirty.x;
               var_312.y = _loc3_.dirty.y;
               var_312.width = _loc3_.dirty.width;
               var_312.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_312);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_649,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_311[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete var_311[param1];
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            _disposed = true;
            var_602 = null;
            for(_loc1_ in var_311)
            {
               delete var_311[_loc1_];
            }
            var_311 = null;
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1553,var_1554))
            {
               if(param2.render(param1,var_1553,var_1554))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            var_311[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_649,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_312.x = param2.x - param1.x;
            var_312.y = param2.y - param1.y;
            var_312.width = param2.width;
            var_312.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_30))
            {
               while(param1.testParamFlag(WindowParam.const_30))
               {
                  ...
                  var_312.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_312,WindowRedrawFlag.const_231);
