package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_880:IItemListWindow;
      
      private var var_348:IScrollbarWindow;
      
      private var var_1531:Boolean = true;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_348)
         {
            var_348 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_348)
            {
               var_348.addEventListener(WindowEvent.const_271,scrollBarEventProc);
               var_348.addEventListener(WindowEvent.const_210,scrollBarEventProc);
            }
         }
         return var_348;
      }
      ...
      override public function dispose() : void
      {
         if(var_348)
         {
            var_348.removeEventListener(WindowEvent.const_271,scrollBarEventProc);
            var_348.removeEventListener(WindowEvent.const_210,scrollBarEventProc);
            var_348 = null;
         }
         if(var_880)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_210)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_880)
         {
            var_880 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_880;
      }
