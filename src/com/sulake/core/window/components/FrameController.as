package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_761:String = "margin_right";
      
      private static const const_1089:String = "_SCALER";
      
      private static const const_1074:String = "_TITLE";
      
      private static const const_1087:String = "_CONTENT";
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_762,_loc3_.left,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_760,_loc3_.top,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_761,0 - _loc3_.right,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_759,0 - _loc3_.bottom,PropertyStruct.const_63,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_211);
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1245 == null)
         {
            var_1245 = findChildByTag(const_1088) as IHeaderWindow;
            if(!var_1245)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1074) as ITextWindow;
            if(!_title)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_237,false);
         }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1087) as IWindowContainer;
            if(!var_20)
            {
