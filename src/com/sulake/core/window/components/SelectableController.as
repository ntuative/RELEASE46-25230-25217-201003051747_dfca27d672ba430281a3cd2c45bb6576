package com.sulake.core.window.components
{
   ...
   public class SelectableController extends InteractiveController implements ISelectableWindow
   {
            ...
            if(var_6)
            {
               if(!(var_6 is ISelectorWindow))
               {
                  ...
                  while(_loc3_)
                  {
                     ...
                     {
                        _loc3_.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_215,this,null));
                        break;
                     }
      ...
      public function select() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_364,this,null);
         update(this,_loc1_);
      ...
      public function unselect() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_713;
         update(this,_loc1_);
         return true;
      }
   }
