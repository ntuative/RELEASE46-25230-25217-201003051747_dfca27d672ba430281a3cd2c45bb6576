package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected var var_2274:uint = 0;
      
      protected var var_934:String = "";
      ...
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_437 = new Array();
         var_437[0] = MouseCursorType.const_318;
         var_437[1] = MouseCursorType.const_36;
         var_437[2] = MouseCursorType.const_318;
         var_437[3] = MouseCursorType.const_318;
         var_437[4] = MouseCursorType.const_36;
         var_437[5] = MouseCursorType.const_36;
         var_437[6] = MouseCursorType.const_318;
         if(var_320 == null)
         {
            var_320 = new Array();
            var_320[0] = WindowState.const_86;
            var_320[1] = WindowState.const_72;
            var_320[2] = WindowState.const_78;
            var_320[3] = WindowState.const_59;
            var_320[4] = WindowState.const_45;
            var_320[5] = WindowState.const_88;
            var_320[6] = WindowState.const_67;
         }
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         ...
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_999,param1.toolTipDelay != const_1394));
         return param2;
      }
      ...
      {
         var_934 = param1 == null ? const_739 : param1;
      }
