package com.sulake.core.window.components
{
   ...
   public class HeaderController extends ContainerController implements IHeaderWindow
   {
      ...
      private static const const_1073:String = "_CONTROLS";
      ...
      {
         return findChildByTag(HeaderController.const_1074) as ITextWindow;
      }
      
      public function get controls() : IItemListWindow
      {
         return findChildByTag(HeaderController.const_1073) as IItemListWindow;
      }
   }
}
