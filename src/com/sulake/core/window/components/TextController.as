package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2332:Rectangle = new Rectangle();
      ...
      protected var var_523:String = "none";
      ...
      {
         return new Rectangle(var_615 * maxScrollH,var_363 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_744)
         {
            context.removeLocalizationListener(var_314,this);
         }
         if(var_67 != null)
         {
            var_67.dispose();
      ...
      {
         var_615 = param1;
         _field.scrollH = var_615 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_314 = param1;
         if(var_314.charAt(0) == "$" && var_314.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_314.slice(2,var_314.indexOf("}")),this);
            var_744 = true;
         }
         else if(_field != null)
         {
      ...
      private function createPropertySetterTable() : Dictionary
      {
         ...
         _loc1_["mouse_wheel_enabled"] = method_11;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_999,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_362,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_362,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_627,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_627,true));
         ...
         _loc1_.push(new PropertyStruct("auto_size",var_523,PropertyStruct.STRING,var_523 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_627,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_523 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_5.x,var_5.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_523 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_5.x,var_5.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_523 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_523 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_5.x,var_5.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
