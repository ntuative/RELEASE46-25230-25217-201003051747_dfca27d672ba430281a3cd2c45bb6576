   ...
   public class ScrollbarLiftController extends InteractiveController implements IDragBarWindow
   {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(param2.type == WindowNotifyEvent.const_402)
         {
            ...
            var_913 = y != 0 ? Number(y / Number(0 - height)) : Number(0);
            if(var_6 != _scrollBar)
            {
               _scrollBar.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_232,this,null));
            }
         }
