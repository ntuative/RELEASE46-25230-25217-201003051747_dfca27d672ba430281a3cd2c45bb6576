package com.sulake.core.window.components
{
   ...
   public class TabButtonController extends SelectableController implements ITabButtonWindow
   {
      ...
      private static const const_1398:String = "TAB_BUTTON_ICON";
      
      private static const const_1399:String = "TAB_BUTTON_CONTENT";
      
      private static const const_1052:String = "TAB_BUTTON_TITLE";
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = ITextWindow(findChildByTag(const_1052));
         if(_loc2_ != null)
         {
            _loc2_.text = param1;
         }
