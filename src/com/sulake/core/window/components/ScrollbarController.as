package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_764:String = "slider_track";
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_493:
               if(param2.type == WindowNotifyEvent.const_232)
               {
                  if(!var_578)
                  {
                     if(_horizontal)
      ...
      {
         return findChildByName(ScrollbarController.const_764) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_839 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_839 != null)
         {
            _loc1_ = findParentByName(var_839) as IScrollableWindow;
            if(_loc1_ == null && var_6 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_6).findChildByName(var_839) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_49)
         {
            ...
            else if(param2.name == ScrollbarController.const_764)
            {
               _loc4_ = new Point();
         ...
         if(param1.type == WindowMouseEvent.const_955)
         {
