package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_611:uint = 16777215;
      ...
      protected var var_314:String = "";
      
      protected var var_75:WindowRectLimits;
      
      protected var var_1360:uint;
      
      protected var var_743:Boolean = false;
      ...
      public function testParamFlag(param1:uint, param2:uint = 0) : Boolean
      {
         if(param2 > 0)
         {
            return (var_14 & param2 ^ param1) == 0;
         }
         return (var_14 & param1) == param1;
      }
