package com.sulake.core.window
{
   ...
   public class WindowContext implements IWindowContext, IDisposable, IUpdateReceiver
   {
      ...
      public static var var_920:MouseEventQueue;
      
      public static var var_1584:IMouseCursor;
      
      public static const const_1535:int = 2;
      
      private static var var_978:Factory;
      ...
      protected var var_2262:IWindowFactory;
      
      private var _disposed:Boolean = false;
      
      private var var_654:WindowController;
      
      private var var_646:Date;
      
      protected var var_2261:IWindowParser;
      ...
      public function WindowContext(param1:String, param2:IWindowRenderer, param3:IWindowFactory, param4:ICoreLocalizationManager, param5:DisplayObjectContainer, param6:Rectangle, param7:IWindowContextStateListener)
      {
         ...
         var_2262 = param3;
         var_2261 = new WindowParser(this);
         var_646 = new Date();
         if(var_978 == null)
         {
            var_978 = new Factory();
         ...
         if(var_920 == null)
         {
            var_920 = new MouseEventQueue(param5);
         }
         if(var_1358 == null)
         {
         ...
         var_1098 = new SubstituteParentController(this);
         var_334 = param7;
      }
      ...
      {
         var _loc12_:Class = var_978.getWindowClassByType(param3);
         if(_loc12_ == null)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc7_:MouseEventQueue = WindowContext.var_920;
         _loc7_.begin();
         var_556.x = -1;
         var_556.y = -1;
         while(true)
         {
            ...
            if(_loc2_.stageX != var_556.x || _loc2_.stageY != var_556.y)
            {
               var_556.x = _loc2_.stageX;
               var_556.y = _loc2_.stageY;
               _loc5_ = new Array();
               var_89.groupChildrenUnderPoint(var_556,_loc5_);
            }
               ...
               if(_loc4_ != null && _loc4_.visible)
               {
                  ...
                  else if(_loc2_.type == MouseEvent.MOUSE_UP || _loc2_.type == MouseEvent.CLICK)
                  {
                     if(var_96 && true)
                     {
                        if(var_334 != null)
                        {
                           var_334.mouseEventReceived(_loc2_.type,var_96);
                        }
                     }
                  }
                  if(_loc2_.altKey)
