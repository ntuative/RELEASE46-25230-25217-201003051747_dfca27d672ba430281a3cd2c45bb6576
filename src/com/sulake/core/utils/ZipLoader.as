package com.sulake.core.utils
{
   ...
   public class ZipLoader extends LibraryLoader
   {
      ...
      private var var_375:FZip;
      
      private var var_1128:Array;
      
      private var var_1665:uint = 0;
      ...
      private function onLoaderComplete(param1:Event) : void
      {
         ...
         var_1128.push(var_15.contentLoaderInfo.applicationDomain.getDefinition(_loc3_));
         ++var_756;
         if(var_1128.length == var_1665)
         {
         ...
         {
            var_15.loadBytes(var_375.getFileAt(var_756).content);
         }
      }
      ...
      override public function load(param1:URLRequest, param2:LoaderContext = null, param3:int = 1) : void
      {
         ...
         var_375 = new FZip();
         var_375.addEventListener(Event.COMPLETE,onComplete);
         var_375.addEventListener(IOErrorEvent.IO_ERROR,onIOError);
         var_375.addEventListener(ProgressEvent.PROGRESS,onProgress);
         var_375.load(var_318);
      }
