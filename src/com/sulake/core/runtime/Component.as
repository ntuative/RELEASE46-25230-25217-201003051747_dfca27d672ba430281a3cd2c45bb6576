package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_896:uint = 4;
      ...
      protected var var_374:uint = 0;
      
      protected var _context:IContext = null;
      
      protected var var_2074:Boolean = false;
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_374 + "]";
      }
   }
}
