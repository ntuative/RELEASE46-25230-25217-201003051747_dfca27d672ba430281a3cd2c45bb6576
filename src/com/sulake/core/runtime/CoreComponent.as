package com.sulake.core.runtime
{
   ...
   public final class CoreComponent extends ComponentContext implements ICore
   {
      ...
      private static const const_1079:String = "asset-libraries";
      ...
      private static const const_1078:String = "component-libraries";
       
      
      private var var_1481:Number = 0;
      
      private var var_1241:IEventDispatcher;
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1195);
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         {
            _loc3_ = var_481[_loc4_] as Array;
      ...
      private function updateLoadingEventDelegate() : void
      {
         ...
         if(var_1241)
         {
            _loc1_ = NaN + (var_1481 > 0 ? var_1481 + var_231.length - 1 : var_231.length);
            if(_loc1_ > 0)
            {
               var_1241.dispatchEvent(new ProgressEvent(ProgressEvent.PROGRESS,false,false,Number(var_260) - _loc1_,Number(var_260)));
            }
            else
            {
               var_1241.dispatchEvent(new Event(Event.COMPLETE));
            }
         }
      }
      ...
      private function simpleFrameUpdateHandler(param1:Event) : void
      {
         ...
         {
            var_575[criticality] = 0;
            receivers = var_481[criticality];
            index = 0;
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:Array = var_481[param2] as Array;
         _loc3_.push(param1);
      }
      ...
      private function complexFrameUpdateHandler(param1:Event) : void
      {
         ...
         while(criticality < CoreComponent.const_129)
         {
            ...
            {
               if(var_575[criticality] < criticality)
               {
                  ++0;
                  skip = true;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            while(_loc3_ < CoreComponent.const_129)
            {
               _loc2_ = var_481[_loc3_] as Array;
