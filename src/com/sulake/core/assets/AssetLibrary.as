package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_877:String = "AssetLibraryReady";
      
      public static const const_1366:String = "AssetLibraryUnloaded";
      
      public static const const_468:String = "AssetLibraryLoaded";
      
      public static const const_1274:String = "AssetLibraryLoadError";
      ...
      private var var_477:Boolean = true;
      
      private var var_338:Class;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_563;
         var_387 = new Dictionary(false);
         var_388 = new Dictionary(false);
         var_671 = new Dictionary(false);
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_387)
         {
            _loc4_ = AssetTypeDeclaration(var_387[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_388)
         {
            _loc2_ = var_388[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_388[_loc1_];
         }
         for(_loc1_ in _loadedAssets)
         {
            delete _loadedAssets[_loc1_];
         }
         for(_loc1_ in var_671)
         {
            delete var_671[_loc1_];
         }
         if(var_15 != null)
         {
            var_15.dispose();
         ...
         var_294 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1366));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_338 = _loc2_.resource;
         if(var_477)
         {
            AssetLibrary.fetchLibraryContents(this,var_476,var_338);
         }
         var_294 = true;
         dispatchEvent(new Event(AssetLibrary.const_468));
         dispatchEvent(new Event(AssetLibrary.const_877));
         if(var_477)
         {
            var_15.dispose();
            var_15 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_388[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_881,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_878,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_895,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_388[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_387.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_387[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_988.splice(var_988.indexOf(this),1);
            --var_563;
            var_388 = null;
            var_671 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_337.length ? getAssetByName(var_337[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1274));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_387)
         {
            _loc3_ = AssetTypeDeclaration(var_387[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_671[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_338[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_388[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_337.splice(var_337.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_387[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_338 != null ? false : false;
      }
   }
}
