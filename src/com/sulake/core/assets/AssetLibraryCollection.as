package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_524:Array;
      
      private var var_620:uint = 0;
      
      protected var var_364:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_364 = new AssetLibrary("lib-" + var_620++);
         var_30.push(var_364);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return var_364.createAsset(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_364.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function unload() : void
      {
         while(false)
         {
            (var_524.pop() as IAssetLibrary).dispose();
         }
         while(false)
         {
      ...
      {
         return var_364.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      {
         return var_364.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return var_364.setAsset(param1,param2,param3);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_364.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < var_524.length)
            {
               _loc3_ = var_524[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  var_524.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
      ...
      {
         return var_364.loadFromResource(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_364.getAssetTypeDeclarationByMimeType(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      {
         return var_364.loadFromArchive(param1,param2);
      }
