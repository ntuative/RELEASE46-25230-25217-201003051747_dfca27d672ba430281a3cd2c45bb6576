package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1630 = param2;
         var_350 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_112,onBadgeImageReady);
         ...
         var_1948 = param5.getKey("notifications.text.achievement_facebook");
      ...
      public function dispose() : void
      {
         if(var_350 != null)
         {
            var_350.events.removeEventListener(BadgeImageReadyEvent.const_112,onBadgeImageReady);
            var_350 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_688,var_1948);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_688,var_688));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_688,var_688));
         _localizations.registerParameter(param1,"level",var_1630.toString());
         _localizations.registerParameter(param1,"name",var_350.userName);
         _localizations.registerParameter(param1,"realname",var_350.realName);
      }
   }
}
