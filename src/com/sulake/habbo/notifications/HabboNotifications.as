package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1128:String = "badges";
      
      private static const const_1126:String = "pixelbalance";
      
      private static const const_1124:String = "credits";
      
      private static const const_1123:String = "inventory";
      
      private static const const_1127:String = "friendlist";
      
      private static const UILINK_SELECTFURNI:String = "selectfurni";
      
      private static const const_1125:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_599:ParkBusDialogManager;
      
      private var var_598:IHabboToolbar;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_424:HabboNotificationViewManager;
      ...
      private var var_730:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_900);
         }
         var _loc6_:Map = var_900["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1248);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_730 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onBroadcastMessageEvent(param1:IMessageEvent) : void
      {
         ...
         _windowManager.alert("${notifications.broadcast.title}",_loc3_,0,method_9);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_858)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1337);
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_76:
               ...
               break;
            case CatalogPageMessageProductData.const_223:
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1386);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_2167)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_549);
            var_2167 = true;
      ...
      override public function dispose() : void
      {
         ...
         if(var_598)
         {
            var_598.release(new IIDHabboToolbar());
            var_598 = null;
         }
         if(_windowManager)
         {
      ...
      {
         if(param1 != null && this.var_424 != null)
         {
            var_424.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_549,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_534.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_901,_loc5_);
         }
      }
      
      public function method_9(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_171 || param2.type == WindowEvent.const_667)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_424.isSpaceAvailable() && false)
         {
            var_424.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_599 == null)
         {
            var_599 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_599 != null)
         {
            var_599.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_1062.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_534.createPetImage(_loc2_.figure,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onPetRespectFailed(param1:IMessageEvent) : void
      {
         ...
         _windowManager.alert("${error.title}","${room.error.pets.respectfailed}",0,method_9);
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_350);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               if(_loc14_.productType == CatalogPageMessageProductData.const_77)
               {
                  _loc15_ = var_350.getFloorItemData(_loc14_.furniClassId);
               }
               else if(_loc14_.productType == CatalogPageMessageProductData.const_76)
               {
                  _loc15_ = var_350.getWallItemData(_loc14_.furniClassId);
               }
               _loc6_ = var_350.getProductData(_loc4_.localizationId);
         ...
         if(_loc8_)
         {
            addItem(_loc8_.value,NotificationType.const_549,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_534.createAvatarImage(param2,AvatarScaleType.const_51);
         if(_loc7_ != null)
         {
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var_1062.push(_loc8_);
         return var_1062.length;
      }
      ...
      {
         var_598 = IHabboToolbar(param2);
         var_598.events.addEventListener(HabboToolbarEvent.const_82,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_350.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_971);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_971);
            }
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 3002)
            {
               return FurniCategory.const_328;
            }
            if(param2 == 4057)
            {
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_82)
         {
            ...
            var_424 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_900["styles"],var_900["view"],var_598);
            ...
            registerUpdateReceiver(var_424,1);
            registerUpdateReceiver(this,2);
            var_350.events.addEventListener(BadgeImageReadyEvent.const_112,onBadgeImage);
            var_598.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
