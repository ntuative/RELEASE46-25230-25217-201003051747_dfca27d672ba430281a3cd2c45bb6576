package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1054:int = -1000000000;
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_909,_loc3_.status);
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_556);
         var _loc8_:int = 0;
         while(_loc8_ < _loc3_.userUpdateCount)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               var_7.method_6(_loc4_,_loc5_,_loc9_.id,_loc11_,_loc13_,_loc12_,_loc9_.dirHead);
               _loc14_ = "null";
               _loc15_ = "";
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               var_7.method_6(_loc3_,_loc4_,_loc9_.id,_loc9_.loc,_loc9_.target);
               switch(_loc9_.moveType)
               {
                  case SlideObjectMessageData.const_799:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_882:
                     _loc10_ = "std";
               }
