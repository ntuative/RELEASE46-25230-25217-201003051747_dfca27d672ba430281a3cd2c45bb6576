package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1561:int = 1500;
      
      private var var_1559:int = 255;
      
      private var var_1560:int = 255;
      
      private var var_1327:uint = 16777215;
      
      private var var_1072:uint = 16777215;
      
      protected var var_79:RoomPlaneParser = null;
      
      private var var_910:int = 0;
      
      private var var_1129:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_544:
                  _loc2_.setString(RoomObjectVariableEnum.const_558,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_650:
                  _loc2_.setString(RoomObjectVariableEnum.const_578,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_637:
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_471:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_216)
                  {
                     _loc8_ = "null";
                  }
                  var_422.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_698:
                  _loc7_ = var_422.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_422.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_990,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_958,int(_loc5_.bgOnly));
            var_1327 = _color;
            var_1559 = var_1129;
            var_1072 = _loc11_;
            var_1560 = _loc12_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1317,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1190,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1172,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_143 || _loc13_ == RoomPlaneData.const_246)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_910)
         {
            ...
            {
               _loc7_ = var_1327 >> 16 & 255;
               _loc8_ = var_1327 >> 8 & 255;
               _loc9_ = var_1327 & 255;
               _loc10_ = var_1072 >> 16 & 255;
               _loc11_ = var_1072 >> 8 & 255;
               _loc12_ = var_1072 & 255;
               _loc13_ = (_loc2_ - var_910) / var_1561;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1559 + (var_1560 - var_1559) * _loc13_;
               _color = _loc3_;
               var_1129 = _loc4_;
            }
