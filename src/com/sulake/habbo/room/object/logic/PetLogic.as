         ...
         if(object != null)
         {
            ...
            if(object.getType() == "pet")
            {
               ...
               if(param1 is RoomObjectAvatarFigureUpdateMessage)
               {
                  ...
                  _loc5_ = _loc2_.getString(RoomObjectVariableEnum.const_168);
                  _loc2_.setString(RoomObjectVariableEnum.const_168,_loc4_.figure);
                  _loc2_.setString(RoomObjectVariableEnum.const_1258,_loc4_.race);
               }
               if(param1 is RoomObjectAvatarWaveUpdateMessage)
               {
                  ...
                  if(_loc6_.isWaving)
                  {
                     _loc2_.setNumber(RoomObjectVariableEnum.const_333,new Date().valueOf());
                  }
                  else
                  {
                     _loc2_.setNumber(RoomObjectVariableEnum.const_333,-1);
                  }
               }
               if(param1 is RoomObjectAvatarSleepUpdateMessage)
               {
                  _loc7_ = param1 as RoomObjectAvatarSleepUpdateMessage;
                  _loc2_.setNumber(RoomObjectVariableEnum.const_352,Number(_loc7_.isSleeping));
               }
               if(param1 is RoomObjectAvatarPetGestureUpdateMessage)
               {
                  _loc8_ = param1 as RoomObjectAvatarPetGestureUpdateMessage;
                  _loc2_.setString(RoomObjectVariableEnum.const_363,_loc8_.gesture);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_445,new Date().valueOf());
               }
               if(param1 is RoomObjectAvatarChatUpdateMessage)
               {
                  _loc9_ = param1 as RoomObjectAvatarChatUpdateMessage;
                  _loc2_.setNumber(RoomObjectVariableEnum.const_509,_loc9_.numberOfWords);
               ...
               if(param1 is RoomObjectAvatarPostureUpdateMessage)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_261,_loc10_.postureType);
               }
               ...
               if(param1 is RoomObjectAvatarExperienceUpdateMessage)
               {
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_859,Number(getTimer()));
                  _loc2_.setNumber(RoomObjectVariableEnum.const_795,Number(_loc12_.gainedExperience));
               }
            }
         }
      }
