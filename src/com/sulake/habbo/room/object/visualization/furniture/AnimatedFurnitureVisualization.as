package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      {
         var _loc3_:* = null;
         if(param1 >= 0 && param1 < var_300.length)
         {
            _loc3_ = var_300[param1] as AnimationFrame;
            if(_loc3_ != null)
            {
               return _loc3_.id;
            }
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         {
            _loc5_ = null;
            if(_loc4_ < var_300.length)
            {
               _loc5_ = var_300[_loc4_] as AnimationFrame;
            }
            ...
            if(_loc5_ == null || _loc5_.remainingFrameRepeats >= 0 && _loc7_ <= 0)
            {
               ...
               if(_loc6_ == AnimationFrame.const_860)
               {
                  _loc5_ = _animationData.getFrame(_loc4_,var_1255,var_442,param1);
               }
               else
               {
                  _loc5_ = _animationData.getFrameFromSequence(_loc4_,var_1255,_loc6_,_loc5_.activeSequenceOffset + 1,var_442,param1);
               }
               var_300[_loc4_] = _loc5_;
               if(_loc5_ != null)
               {
                  _loc3_ = true;
               }
