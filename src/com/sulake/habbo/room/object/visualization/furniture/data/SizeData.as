package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_325:int = 1000;
      ...
      private var var_1132:int = 360;
      
      private var var_1682:int = 0;
      
      private var var_631:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1132 / 2) % 360 / var_1132;
         if(var_212.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         {
            _loc6_ = int(var_212.getKey(_loc5_)) * var_1132;
         ...
         if(_loc4_ >= 0)
         {
            return int(var_212.getKey(_loc4_));
         }
         return const_1351;
      }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_817);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_995);
                  break;
               case "DARKEN":
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = var_212.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(var_212 != null)
         {
            ...
            {
               _loc2_ = var_212.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc7_ = int(_loc6_.@id);
            _loc8_ = _loc6_.layer;
            if(var_212.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            ...
            var_212.add(String(_loc7_),_loc3_);
            var_1131 = -1;
            var_631 = null;
            _loc5_++;
         }
