package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_744:int = 15;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_944[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_943[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_944 = new Array();
         var_944.push(Math.random() * _loc2_ * 1.5);
         var_944.push(Math.random() * _loc2_ * 1.5);
         var_946 = new Array();
         var_946.push(1);
         var_946.push(-1);
         var_945 = new Array();
         var_945.push(const_1038);
         var_945.push(const_1037);
         var_943 = new Array();
         var_943.push(getRandomAmplitudeFactor());
         var_943.push(getRandomAmplitudeFactor());
      }
