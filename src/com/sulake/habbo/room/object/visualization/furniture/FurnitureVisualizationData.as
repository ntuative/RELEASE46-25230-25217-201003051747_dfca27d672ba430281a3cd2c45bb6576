package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_515:SizeData = null;
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         {
            var_515 = var_279.getValue(String(_sizes[_loc2_])) as SizeData;
         }
         else
         {
            var_515 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_279 != null)
         {
            ...
            {
               _loc1_ = var_279.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(var_279.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            var_279.add(String(_loc6_),_loc9_);
            _sizes.push(_loc6_);
