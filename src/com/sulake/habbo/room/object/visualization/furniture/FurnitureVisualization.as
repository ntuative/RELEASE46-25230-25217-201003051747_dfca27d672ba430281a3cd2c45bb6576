package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1387:Number = Math.sqrt(0.5);
      ...
      protected var var_2257:Number = NaN;
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_817:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_995:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      {
         var _loc3_:int = 0;
         if(var_1768 != param1 || var_1769 != param2)
         {
      ...
      {
         var _loc3_:int = 0;
         if(var_1771 != param1 || var_1770 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2259 = _loc3_.getNumber(RoomObjectVariableEnum.const_185);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_220));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            var_1575 = _loc3_.getString(RoomObjectVariableEnum.const_298);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_284 != _loc3_.getUpdateID() || param1 != var_209 || param2 != var_2257)
         {
