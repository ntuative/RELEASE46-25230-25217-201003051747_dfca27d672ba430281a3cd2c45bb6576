package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_791:PetVisualizationData = null;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc10_:* = 0;
         var _loc12_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_859);
         if(_loc12_ > 0)
         {
            ...
            if(_loc17_ < AvatarAction.const_988)
            {
               ...
               _loc11_ = _loc4_.getNumber(RoomObjectVariableEnum.const_795);
               var_474 = const_1060;
            }
         }
         var _loc13_:Boolean = false;
         var _loc14_:String = _loc4_.getString(RoomObjectVariableEnum.const_261);
         switch(_loc14_)
         {
         ...
         var _loc15_:Boolean = var_284 != _loc3_.getUpdateID() || var_209 != param1.scale || var_160 != _loc4_.getUpdateID();
         var _loc16_:Boolean = _isAnimating || var_474 > 0 || _loc13_;
         if(_loc15_ || _loc16_)
         {
            increaseUpdateId();
            _loc18_ = getTimer();
            ...
            if(var_530 != _loc7_)
            {
               for each(_loc36_ in var_386.getKeys())
               {
                  var_386.remove(_loc36_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            ...
            _loc21_ = _loc4_.getString(RoomObjectVariableEnum.const_261);
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_703);
            _loc6_.appendAction(AvatarAction.const_552,_loc21_,_loc22_);
            _loc23_ = false;
            if(_loc21_ == "lay")
            {
            ...
            _loc24_ = _loc4_.getString(RoomObjectVariableEnum.const_363);
            if(_loc24_ != null && _loc24_ != "")
            {
               _loc38_ = _loc4_.getNumber(RoomObjectVariableEnum.const_445);
               _loc39_ = 3;
               _loc40_ = _loc8_ - _loc38_;
               if(_loc40_ < _loc39_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_278,_loc24_);
               }
            }
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_352) > 0;
            if(_loc25_)
            {
            ...
            _loc30_ = _loc6_.getSprites().length + const_1061;
            ...
            _loc31_ = getSprite(const_1612);
            if(_loc10_ > 0)
            {
               _loc29_ = null;
               _loc29_ = var_791.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
               if(_loc29_ != null)
               {
            ...
            var_790.push(getTimer() - _loc18_);
            if(false)
            {
               _loc56_ = 0;
               _loc57_ = "[";
               for each(_loc58_ in var_790)
               {
                  _loc56_ += _loc58_;
                  _loc57_ += "," + _loc58_;
               }
      ...
      {
         var_791 = param1 as PetVisualizationData;
         createSprites(4);
         return true;
      }
