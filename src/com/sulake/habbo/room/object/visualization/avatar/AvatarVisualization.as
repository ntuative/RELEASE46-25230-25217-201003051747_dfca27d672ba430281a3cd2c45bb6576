package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1406:int = 0;
      
      private var var_530:String;
      
      private var var_620:int = 0;
      
      private const const_1611:int = 1;
      ...
      private const const_1612:int = 2;
      
      private var var_791:AvatarVisualizationData = null;
      ...
      {
         var_791 = param1 as AvatarVisualizationData;
         createSprites(const_1061);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_386.getValue(_loc5_) as IAvatarImage;
         ...
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_509);
         ...
         var _loc14_:Number = _loc8_ - var_1175;
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_333);
         if(_loc16_ > 0)
         {
         ...
         var _loc20_:Boolean = var_284 != _loc3_.getUpdateID() || var_209 != param1.scale || var_160 != _loc4_.getUpdateID();
         var _loc21_:Boolean = _isAnimating || var_474 > 0;
         if(_loc20_ || _loc21_)
         {
            increaseUpdateId();
            --var_474;
            ...
            if(var_530 != _loc7_)
            {
               for each(_loc49_ in var_386.getKeys())
               {
                  var_386.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_791.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
               var_386.remove(_loc5_);
               var_386.add(_loc5_,_loc6_);
               var_530 = _loc7_;
            }
            ...
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_261) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_261);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_703);
            _loc6_.appendAction(AvatarAction.const_552,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_363);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_51)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_445);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_278,AvatarAction.const_1233[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_899);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_845,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_936);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_1019);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_807,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_620);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_722);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_1017,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_871);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_997,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_474);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_352) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_580);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_349);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_900);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_585,_loc36_);
            }
            ...
            _loc43_ = getSprite(const_1612);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_843))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_791.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_284 = _loc3_.getUpdateID();
            var_160 = _loc4_.getUpdateID();
            var_209 = param1.scale;
            var_790.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_790)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_386 != null)
         {
            _loc1_ = var_386.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_386.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
