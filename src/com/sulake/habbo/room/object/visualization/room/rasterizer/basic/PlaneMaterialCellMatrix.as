package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1369:int = const_329;
      ...
      public static const const_252:int = const_99;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1384 == const_99)
         {
            _loc5_ = new Rectangle(0,0,var_26.width,var_441);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_441,var_26.width,var_441);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_26 != null)
            {
               if(var_26.width == param2 && var_26.height == param3 && Vector3d.isEqual(var_751,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_441,param6,param7);
                     return param1;
                  }
                  return var_26;
               }
