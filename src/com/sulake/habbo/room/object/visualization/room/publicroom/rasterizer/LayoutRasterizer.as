package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_967:Point = null;
      
      private var var_459:Array;
      
      private var var_969:LayoutRasterizerData = null;
      ...
      private var var_458:Boolean = true;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_968 = param1;
         var _loc3_:LayoutRasterizerData = var_64.getValue(var_644);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1145 = RoomObjectVariableEnum.const_1009;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1145 = RoomObjectVariableEnum.const_839;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_968 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_968 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_968 + _adBgIndex);
            _loc5_ = param1.getSprite(var_968 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1145);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_390;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1722);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_644)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_969 = var_64.getValue(var_644);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_64.getValue(var_644);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_969.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_967.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_967.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_327.indexOf(_loc10_) >= 0 && var_458)
            {
               param1 = var_327.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = _assetCollection.getAsset(var_457[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(true)
               {
                  param2.alpha = var_459[param1];
               }
               var_327.splice(param1,1);
               var_457.splice(param1,1);
               var_459.splice(param1,1);
               if(false)
               {
                  var_458 = false;
               }
