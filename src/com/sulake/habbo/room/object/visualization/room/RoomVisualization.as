package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1157:int = 13421772;
      
      private static const const_1120:int = 16777215;
      
      public static const const_1359:int = 10066329;
      
      private static const const_1122:int = 13421772;
      
      public static const const_1210:int = 16777215;
      
      private static const const_1423:int = 0;
      
      public static const const_1213:int = 16777215;
      
      private static const const_1119:int = 10066329;
      
      private static const const_1121:int = 10066329;
      
      public static const const_1254:int = 13421772;
      ...
      private var var_595:Rectangle = null;
      ...
      private var var_422:RoomPlaneBitmapMaskParser = null;
      ...
      public function RoomVisualization()
      {
         ...
         var_422 = new RoomPlaneBitmapMaskParser();
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_794);
         var _loc7_:int = 0;
         while(_loc7_ < var_79.planeCount)
         {
            ...
            if(_loc12_ == RoomPlaneData.const_138)
            {
               ...
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1210;
               }
               else
               {
                  _loc13_.color = const_1157;
               }
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_263,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_263 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_595 == null)
         {
            var_595 = super.boundingRectangle;
         }
         return new Rectangle(var_595.x,var_595.y,var_595.width,var_595.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_422.maskCount)
         {
            _loc6_ = var_422.getMaskType(_loc5_);
            _loc7_ = var_422.getMaskLocation(_loc5_);
            _loc8_ = var_422.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_106.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_263 || _loc3_.type == RoomPlane.const_177 && _loc8_ == RoomPlaneBitmapMaskData.const_216)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1544;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1154)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_974 || _loc9_.y != var_1761 || _loc9_.z != var_1759 || param1.scale != var_1762))
            {
               var_974 = _loc9_.x;
               var_1761 = _loc9_.y;
               var_1759 = _loc9_.z;
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_990);
            if(_loc10_ != var_2148)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_721));
            if(_loc11_ != var_1061)
            {
               var_1061 = _loc11_;
               var_2150 = var_1061 & 255;
               var_2153 = var_1061 >> 8 & 255;
               var_2149 = var_1061 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_2079 + const_1633 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_2079 = _loc7_;
         if(var_160 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_578);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_558);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_511);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_2151 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_958));
            var_160 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_423.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_423[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_177)
            {
               if(var_2151)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_2150 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_2153 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_2149 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_106.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_263 && param2 != null)
               {
                  _loc5_.id = param2;
               }
