package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1592:int = 16777216;
      ...
      private var var_1549:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1549 * param2);
      }
      ...
      {
         var _loc1_:int = var_2342 * var_1323 + var_2341;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
