package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_566:PlaneMaskManager = null;
      ...
      private var var_1467:Boolean = true;
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_263 || _type == const_177))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_817 || false && false && !var_153 || var_566 == null)
         {
            return;
         }
         ...
         if(var_153)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(var_463);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < var_198.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  var_566.updateMask(var_57,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  var_679.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(_type == const_263 || _type == const_177)
         {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         if(true)
         {
            while(_loc1_ < var_198.length)
            {
               ...
               {
                  _loc6_ = false;
                  while(_loc2_ < var_679.length)
                  {
                     _loc7_ = var_679[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
      ...
      public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : Boolean
      {
         ...
         if(param3)
         {
            ...
            _loc5_ = 0;
            while(_loc5_ < var_1213.length)
            {
               _loc4_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1213[_loc5_]));
               if(_loc4_ > -0.001)
               {
                  if(_isVisible)
                  {
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         updateMaskChangeStatus();
         if(_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || var_153)
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            if(var_680 != null)
            {
               _loc3_ = var_680.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1467,var_1906,var_1905,var_1903,var_1904,param2);
               if(_loc3_ != null)
               {
