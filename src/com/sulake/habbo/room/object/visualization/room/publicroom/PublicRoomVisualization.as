   ...
   public class PublicRoomVisualization extends RoomVisualization
   {
      ...
      private function initializeLayout(param1:IRoomGeometry) : void
      {
         ...
         if(data != null)
         {
            ...
            {
               data.layoutRasterizer.setElementToSprite(_loc4_,getSprite(_loc4_ + var_1099));
               _loc4_++;
            }
            data.layoutRasterizer.initializeAds(var_1099,this);
         }
         var_1815 = true;
      }
