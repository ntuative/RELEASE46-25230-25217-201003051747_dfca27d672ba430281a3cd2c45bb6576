package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellColumn
   {
      ...
      public static const const_218:int = 4;
      ...
      private var var_751:Vector3d = null;
      ...
      private function renderRepeatLast(param1:IVector3d) : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:int = 0;
         _loc3_ = renderCells(var_32,_loc3_,true,param1);
         _loc2_ = var_32["-1"] as PlaneMaterialCell;
         if(_loc2_ != null)
         {
            _loc4_ = [_loc2_];
      ...
      private function renderRepeatBorders(param1:IVector3d) : void
      {
         ...
         while(_loc7_ < -1)
         {
            _loc2_ = var_32[_loc7_] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
         ...
         if(false)
         {
            _loc2_ = var_32[0] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
               _loc6_ = _loc2_.getHeight(param1);
               if(_loc6_ > 0)
      ...
      private function renderRepeatNone(param1:IVector3d) : void
      {
         ...
         renderCells(var_32,0,true,param1);
      }
      ...
      private function renderRepeatFirst(param1:IVector3d) : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:int = 0;
         _loc3_ = renderCells(var_32,_loc3_,false,param1);
         _loc2_ = var_32[0] as PlaneMaterialCell;
         if(_loc2_ != null)
         {
            _loc4_ = [_loc2_];
      ...
      private function renderRepeatCenter(param1:IVector3d) : void
      {
         ...
         while(_loc9_ < 0)
         {
            _loc2_ = var_32[_loc9_] as PlaneMaterialCell;
            if(_loc2_ != null)
            {
      ...
      private function renderRepeatAll(param1:IVector3d) : void
      {
         ...
         var _loc2_:int = getCellsHeight(var_32,param1);
         var _loc3_:int = 0;
      ...
      {
         var _loc3_:int = 0;
         if(var_1385 == const_513)
         {
            _loc3_ = getCellsHeight(var_32,param2);
            param1 = _loc3_;
         }
         if(isStatic)
         {
            if(var_26 != null)
            {
               if(var_26.height == param1 && Vector3d.isEqual(var_751,param2))
               {
                  return var_26;
               }
               var_26.dispose();
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_32.length)
            {
               _loc2_ = var_32[_loc1_] as PlaneMaterialCell;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
