package com.sulake.habbo.room.object.visualization.room.rasterizer.animated
{
   ...
   public class LandscapeRasterizer extends PlaneRasterizer
   {
      ...
      private function parseLandscapes(param1:XML) : void
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            if(XMLValidator.checkRequiredAttributes(_loc6_,["id"]))
            {
               ...
               if(var_330.getValue(_loc7_) == null)
               {
                  var_330.add(_loc7_,_loc9_);
               }
               else
               {
                  _loc9_.dispose();
      ...
      {
         var _loc13_:LandscapePlane = var_330.getValue(param2);
         if(_loc13_ == null)
         {
            _loc13_ = var_330.getValue(const_738);
         }
         if(_loc13_ == null)
         {
            return null;
      ...
      override public function dispose() : void
      {
         ...
         if(var_330 != null)
         {
            ...
            {
               _loc2_ = var_330.getWithIndex(_loc1_) as LandscapePlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
