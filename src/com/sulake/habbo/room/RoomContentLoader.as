package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_783:String = "tile_cursor";
      ...
      private static const const_1132:String = const_347;
      ...
      public static const const_540:String = "RCL_LOADER_READY";
      ...
      private var var_1085:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         var_521 = [];
         var_519 = [];
         var_2239 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2236 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_430 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_289,_loc4_);
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_102 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_520.add(_loc10_,_loc11_);
                              if(var_521.indexOf(_loc14_) < 0)
                              {
                                 var_521.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_430 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_430.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_430.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = var_430.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_347,const_496,ROOM_CONTENT,const_783,const_784];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2239.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_152 && _loc5_ != RoomObjectLogicEnum.const_102)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_520.getValue(param1) as String;
      ...
      {
         if(var_608.getValue(param1) != null)
         {
            return var_608.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1138);
               return;
            }
         }
      }
      ...
      public function method_4(param1:int, param2:String = null) : String
      {
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2236.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1350.add(_loc5_,_loc8_);
               var_179 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_289,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_458,_loc5_);
         }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_253;
         }
         return RoomObjectCategoryEnum.const_212;
      }
      ...
      private function continueInitilization() : void
      {
         if(var_2238)
         {
            ...
            if(var_1085 != null)
            {
               var_1085.dispatchEvent(new Event(const_540));
            }
         }
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            _loc5_.addEventListener(AssetLoaderEvent.const_29,furniDataLoadedHandler);
            _loc5_.addEventListener(AssetLoaderEvent.const_42,furniDataLoadedHandler);
            var_1085 = param1;
            var_2235 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2234 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2233 = param2.getKey("public.room.dynamic.download.url","");
            var_2237 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_34 = const_785;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(var_431 != null)
         {
            var_431.remove(param2);
            var_431.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_152 && _loc5_ != RoomObjectVisualizationEnum.const_102)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_412.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1350.getValue(param1) != null)
         {
            var_179 = var_1350.getValue(param1) as PublicRoomData;
         }
