package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_741:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1027:String = "tile_cursor";
      
      private static const const_274:int = -1;
       
      
      private var var_412:IRoomObjectVisualizationFactory = null;
      ...
      private var var_625:RoomMessageHandler = null;
      
      private var var_624:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         var_625 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_65 != null)
         {
            ...
            {
               return var_65.deleteWallItem(var_109,var_108,param1);
            }
         }
         return false;
      }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_288.length; _loc2_++)
         {
            _loc3_ = var_288.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_589) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_704) - 0.5;
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_65 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_28)
            {
               return var_65.modifyWallItemData(var_109,var_108,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_412 != null)
         {
            var_412.release(new IIDRoomObjectVisualizationFactory());
            var_412 = null;
         }
         if(var_40 != null)
         {
         ...
         if(var_624 != null)
         {
            var_624.release(new IIDRoomRendererFactory());
            var_624 = null;
         }
         ...
         if(var_288 != null)
         {
            ...
            {
               _loc2_ = var_288.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_624.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_922;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_556);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_688);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_601);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_830);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_890);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_863) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_850);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_471,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_698,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_638,var_109,var_108,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_65 != null)
         {
            return var_65.modifyRoomObject(var_109,var_108,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_287.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_287.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_544,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_650,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_637,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_40 != null)
         {
            ...
            var_40.addObjectUpdateCategory(RoomObjectCategoryEnum.const_253);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_65 != null)
         {
            var_65.handleRoomObjectEvent(param1,var_109,var_108);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_185,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_314,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_298,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1002,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_870,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_793,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_235,param1,param2,param3,RoomObjectCategoryEnum.const_31));
         }
         return true;
      }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_711,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_25 == null || var_412 == null || var_40 == null || var_624 == null || _communication == null || var_98 == null || !var_1610)
         {
            return;
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_98 as Component).events.addEventListener(HabboConfigurationEvent.INIT,onHabboConfigurationInit);
      }
      
      public function getObjectRoom(param1:int, param2:int) : IRoomObjectController
      {
         return getObject(getRoomIdentifier(param1,param2),const_274,RoomObjectCategoryEnum.const_62);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_40.getRoom(getRoomIdentifier(var_109,var_108));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_740,RoomObjectCategoryEnum.const_253);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_109,var_108,var_1112);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_109,var_108,var_1112);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_412 = param2 as IRoomObjectVisualizationFactory;
         if(var_9 != null)
         {
            var_9.visualizationFactory = var_412;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_25 != null)
         {
            if(false)
            {
               var_25.events.addEventListener(RoomObjectMouseEvent.const_202,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMouseEvent.const_477,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMouseEvent.const_440,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectStateChangeEvent.const_229,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectStateChangeEvent.const_530,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_114,roomObjectEventHandler);
               ...
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_127,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_124,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_93,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_391,roomObjectEventHandler);
               ...
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_424,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_462,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_START,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_379,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_434,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_447,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_442,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectDimmerStateUpdateEvent.DIMMER_STATE,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMoveEvent.const_386,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMoveEvent.const_452,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_266,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_404,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_308,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_279,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_388,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_865,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_412,roomObjectEventHandler);
               var_25.events.addEventListener(AvatarWalkWarpingWarningEvent.const_467,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(var_65 != null)
         {
            return var_65.initializeRoomObjectInsert(var_109,var_108,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            ...
            {
               _loc3_ = var_287.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_235,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_28:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_185));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_361);
                     break;
                  case RoomObjectCategoryEnum.const_34:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_168);
               }
            }
         }
      ...
      private function method_4(param1:int, param2:String = null) : String
      {
         if(var_9 != null)
         {
            return var_9.method_4(param1,param2);
         }
         return "";
      }
      ...
      public function method_6(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_540)
         {
            var_1610 = true;
            initializeRoomManager();
         }
      ...
      {
         var _loc9_:String = method_4(param4,param8);
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_185,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_314,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_298,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_922,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_235,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
         return true;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _adManager.events.addEventListener(AdEvent.const_481,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_741) as Sprite;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = var_288.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_624 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_439 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_40.getRoom(const_483);
         if(_loc10_ == null)
         {
            _loc10_ = var_40.createRoom(const_483,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_528.method_14();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_31:
            case RoomObjectCategoryEnum.const_28:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_185,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_361,param8);
               break;
            case RoomObjectCategoryEnum.const_34:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_168,param2);
               break;
            case RoomObjectCategoryEnum.const_62:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_558,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_578,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_511,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_471,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_937.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_872,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
      ...
      public function getWallItemImage(param1:int, param2:IVector3d, param3:int, param4:IGetImageListener, param5:String = null, param6:uint = 0) : ImageResult
      {
         ...
         if(var_9 != null)
         {
            _loc7_ = var_9.method_4(param1,param5);
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_742,RoomObjectCategoryEnum.const_253);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = getRoomCanvas(var_109,var_108,param1);
         if(_loc9_ != null)
         {
            var_1112 = param1;
            var_1380 = param2;
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1380 - _loc12_.width / 2;
               _loc11_.y = var_1381 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_360,var_109,var_108,-1,RoomObjectCategoryEnum.const_212));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_65 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_274,const_484);
                  var_65.handleRoomObjectEvent(_loc14_,var_109,var_108);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = getRoomObjectImage(var_109,var_108,param1,param2,new Vector3d(),1,null);
         }
         else if(var_9 != null)
         {
            _loc8_ = null;
            ...
            {
               _loc8_ = var_9.method_4(param1,param4);
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_109,var_108,var_1112);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1380 - _loc6_.data.width / 2;
               _loc11_.y = var_1381 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_9 != null)
         {
            ...
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1009,param1.adWarningL,true);
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_839,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_932,RoomObjectVariableEnum.const_293,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_288.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_288.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_9 != null)
         {
            _events.addEventListener(RoomContentLoader.const_540,onContentLoaderReady);
            var_9.initialize(_events,var_98);
         }
         initializeRoomManager();
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_65 != null)
         {
            var_65.cancelRoomObjectInsert(var_109,var_108);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_40.getRoom(const_483);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_872);
               ...
               _loc13_ = var_937.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_109,var_108,const_274,RoomObjectCategoryEnum.const_62,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_274,_loc12_,_loc8_) as IRoomObjectController;
            ...
            _loc13_ = parseInt(var_98.getKey("ads.billboard.displayDelayMillis","1000"));
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_274,const_484,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_719,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_556,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_589,_loc16_);
               ...
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_794,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_544,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_650,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_637,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_471,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_216);
                     ...
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           ...
                           _loc7_.setNumber(RoomObjectVariableEnum.const_601,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_688,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_601,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_830,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_890,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_742,const_1027,RoomObjectCategoryEnum.const_253);
         _loc7_.createRoomObject(const_740,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_253);
         return _loc7_;
      }
