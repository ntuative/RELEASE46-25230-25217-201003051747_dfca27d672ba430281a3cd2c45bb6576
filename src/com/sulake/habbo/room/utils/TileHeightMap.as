package com.sulake.habbo.room.utils
{
   public class TileHeightMap
   {
      ...
      {
         var _loc3_:* = null;
         if(param1 >= 0 && param1 < var_138 && param2 >= 0 && param2 < var_137)
         {
      ...
      public function validateLocation(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:int) : Boolean
      {
         ...
         if(param1 + param3 > var_138 || param2 + param4 > var_137)
         {
            return false;
         }
         if(param5 < 0 || param5 >= var_138)
         {
            param5 = 0;
         }
         if(param6 < 0 || param6 >= var_137)
         {
            param6 = 0;
         }
         if(param7 > var_138)
         ...
         if(param5 + param7 >= var_138)
         {
            param7 = var_138 - param5;
         }
         if(param6 + param8 >= var_137)
         {
            param8 = var_137 - param6;
         }
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         var _loc11_:* = null;
