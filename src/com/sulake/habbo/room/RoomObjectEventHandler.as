package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc8_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_320);
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_724);
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_866);
      ...
      private function getValidFurnitureDirection(param1:IRoomObjectController, param2:Boolean) : int
      {
         ...
         {
            _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.const_702);
         }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomObjectFurnitureActionEvent.const_442:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_926));
         }
      }
      ...
      private function placeObject(param1:int, param2:int) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_31 || _loc5_ == RoomObjectCategoryEnum.const_34)
               {
                  _loc7_ = _loc11_.x;
                  _loc8_ = _loc11_.y;
               }
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_34 && _loc3_.typeId == RoomObjectTypeEnum.const_283)
               {
         ...
         {
            _roomEngine.events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_206,param1,param2,_loc4_,_loc5_));
         }
         resetSelectedObjectData(param1,param2);
      }
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.const_28:
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_518,param1,param2,param3,param4));
         }
      }
      ...
      private function setObjectAlphaMultiplier(param1:IRoomObjectController, param2:Number) : void
      {
         ...
         {
            param1.getModelController().setNumber(RoomObjectVariableEnum.const_220,param2);
         }
      }
         ...
         if(_loc6_ == null)
         {
            ...
            if(_loc5_.category == RoomObjectCategoryEnum.const_31)
            {
               if(_loc6_ != null)
               {
                  ...
                  {
                     _loc10_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_702);
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         var _loc10_:String = getMouseEventId(RoomObjectCategoryEnum.const_212,MouseEvent.CLICK);
         switch(_loc4_)
         {
         ...
         if(_loc8_ == RoomObjectCategoryEnum.const_62)
         {
            ...
            if(_loc12_ != _loc10_)
            {
               ...
               if(_loc13_ != null)
               {
                  _loc13_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_360,param2,param3,-1,RoomObjectCategoryEnum.const_212));
               }
               setSelectedAvatar(param2,param3,0,false);
            }
         }
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.const_31 || _loc8_ == RoomObjectCategoryEnum.const_28)
               {
                  if(param1.altKey)
                  {
                     ...
                     if(_loc10_ != null)
                     {
                        _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_570,param2,param3,_loc6_,_loc8_));
                     }
                  }
               }
         }
      ...
      private function validateFurnitureLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:TileHeightMap) : Vector3d
      {
         ...
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_320);
         var _loc8_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_478);
         if(_loc7_ < 1)
         {
            _loc7_ = 1;
         }
      ...
      private function handleObjectRoomAdEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomAdEvent.const_266:
               ...
               _loc7_ = "null";
               break;
            case RoomObjectRoomAdEvent.const_404:
               _loc7_ = "null";
               break;
            case RoomObjectRoomAdEvent.const_308:
               _loc7_ = "null";
               break;
            case RoomObjectRoomAdEvent.const_279:
               _loc7_ = "null";
         }
         if(_loc7_ == null)
         {
      ...
      private function handleRoomObjectMouseEvent(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectMouseEvent.const_477:
               ...
               break;
            case RoomObjectMouseEvent.const_440:
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = _roomEngine.getRoomObject(roomId,roomCategory,var_960,category) as IRoomObjectController;
         ...
         if(selectionArrow != null && selectionArrow.getEventHandler() != null)
         {
            if(wasSelected)
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_380));
            }
            else
            {
      ...
      private function handleRoomActionEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            switch(param1.type)
            {
               case RoomObjectRoomActionEvent.const_388:
                  ...
                  break;
               case RoomObjectRoomActionEvent.const_412:
      ...
      private function validateFurnitureDirection(param1:IRoomObject, param2:IVector3d, param3:TileHeightMap) : Boolean
      {
         ...
         var _loc6_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_320);
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_478);
         if(_loc6_ < 1)
         {
            _loc6_ = 1;
         }
      ...
      {
         var _loc3_:Map = var_544.getValue(String(param1)) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         var _loc4_:Map = var_544.getValue(String(param1)) as Map;
         if(_loc4_ == null)
         {
            _loc4_ = new Map();
            var_544.add(param1,_loc4_);
         }
         ...
         if(_roomEngine != null)
         {
            ...
            if(_loc8_ != null && _loc8_.getEventHandler() != null)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc8_.getEventHandler().processUpdateMessage(_loc10_);
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_380);
               }
               else
               {
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_229:
               ...
               break;
            case RoomObjectStateChangeEvent.const_530:
            ...
            case RoomObjectDimmerStateUpdateEvent.DIMMER_STATE:
               ...
               break;
            case RoomObjectMoveEvent.const_386:
               handleSelectedObjectMove(param1,param2,param3);
               break;
            case RoomObjectMoveEvent.const_452:
            ...
            case RoomObjectRoomAdEvent.const_279:
               ...
               break;
            case RoomObjectRoomActionEvent.const_388:
            case RoomObjectRoomActionEvent.const_865:
            case RoomObjectRoomActionEvent.const_412:
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_START:
               ...
               break;
            case RoomObjectFurnitureActionEvent.const_379:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_1173));
               break;
            case RoomObjectFurnitureActionEvent.const_434:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_926));
         }
