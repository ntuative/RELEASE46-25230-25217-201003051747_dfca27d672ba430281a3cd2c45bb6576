package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1570:Number = 15;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_140 = _window.width;
         var_204 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_56,HabboWindowStyle.const_989,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1083 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1083)
         {
         ...
         var_1340 = _loc7_.toolbar.@margin_bottom;
         var_1570 = _loc7_.toolbar.@min_group_margin;
         var_1571 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_280,param1,param2,_window,var_263);
         createGroupsFromXmlList(_loc9_,var_604,param1,param2,var_204,var_263);
         alignWindows();
      }
      ...
      public function dispose() : void
      {
         ...
         while(false)
         {
            _loc1_ = var_280.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         while(false)
         {
            _loc1_ = var_604.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(_window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_140,var_516,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         {
            case "LEFT":
               _window.width = var_140;
               _window.height = _loc1_.height;
               _window.x = 0;
               _window.y = 0;
               var_204.x = var_140 + var_1571;
               var_204.y = 0;
               _loc4_ = 0;
               break;
            case "RIGHT":
               _window.width = var_140;
               _window.height = _loc1_.height;
               _window.x = _loc1_.width - var_140;
               _window.y = 0;
               var_204.x = 0;
               var_204.y = 0;
               _loc4_ = 0;
            ...
            case "TOP":
               ...
               _window.height = var_140;
               _window.x = 0;
               _window.y = 0;
               var_204.x = 0;
               var_204.y = var_140 + var_1571;
               _loc4_ = 0;
               break;
            case "BOTTOM":
               _window.width = _loc1_.width;
               _window.height = var_140;
               _window.x = 0;
               _window.y = _loc1_.height - var_140;
               var_204.x = 0;
               var_204.y = 0;
               _loc4_ = 0;
         }
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1570,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1340) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1570,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1340) / -1));
         ...
         _loc2_ = 0;
         while(_loc2_ < var_604.length)
         {
            _loc3_ = var_604[_loc2_];
            if(_loc3_ != null)
            {
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,_events,param5,param6,var_140);
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - var_140)
         {
            return "RIGHT";
         }
         if(param2 <= var_140)
         ...
         if(param2 >= _loc3_.height - var_140)
         {
            return "BOTTOM";
         }
         return null;
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_140,var_516);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         var _loc3_:int = 0;
         _loc3_ = 0;
         while(_loc3_ < var_280.length)
         {
            _loc2_ = var_280[_loc3_];
         ...
         _loc3_ = 0;
         while(_loc3_ < var_604.length)
         {
            _loc2_ = var_604[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_516);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_140,var_516);
         }
      }
