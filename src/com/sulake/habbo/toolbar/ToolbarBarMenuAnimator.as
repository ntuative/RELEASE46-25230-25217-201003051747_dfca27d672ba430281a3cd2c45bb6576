package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_775:int = 50;
      
      private static const const_1047:Number = 25;
      
      private static const const_1129:int = 50;
      ...
      private var var_1065:ToolbarView;
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_509.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_509.splice(_loc3_,1);
            var_508.splice(_loc3_,1);
         }
         var_508.push(param1.name);
         var_509.push(param2);
         param1.addEventListener(WindowEvent.const_375,windowEventListener);
         param1.addEventListener(WindowEvent.const_210,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_509[var_508.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1065.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_310.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_310.splice(var_310.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1065.getIconLoc(param1.iconId);
      ...
      {
         return var_508[var_509.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_310[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_775 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_775 || param1.desktop.height - param1.y < const_1129;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_508[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
