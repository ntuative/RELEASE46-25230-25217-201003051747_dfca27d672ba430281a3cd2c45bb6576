package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_1261 = param1.loop;
         if(param1.background != null)
         {
            var_854 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_855.push(new XML());
               var_856.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_856[var_51] = param6.clone();
         }
      ...
      {
         if(var_1261 == true || var_710 == 0)
         {
            if(false)
            {
               ++var_51;
               if(var_51 >= var_855.length)
               {
                  var_51 = 0;
                  ++var_710;
               }
      ...
      {
         return var_855.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1261 == false && var_710 == 1 && var_1286 != var_34;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_854 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_854.width),Math.max(param2.height,var_854.height));
            _loc3_.copyPixels(var_854,var_854.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_51 <= var_856.length)
         {
            _loc2_ = var_856[var_51];
