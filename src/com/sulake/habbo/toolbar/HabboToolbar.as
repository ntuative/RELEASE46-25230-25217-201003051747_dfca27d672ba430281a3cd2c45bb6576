package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_292.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_108,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_993,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_157,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_161,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_46,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_436,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_714,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_879,onHideWindowEvent);
         var_34 = true;
