package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_1593:XML;
      
      private var var_1594:int;
      
      private var var_1108:Number;
      ...
      {
         return var_1106.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1107.length)
         {
            _loc2_ = var_621.indexOf(var_1107[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_286[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_825 + _loc3_);
                  _loc3_ += var_1108;
               }
            }
            _loc4_++;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = var_621.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = getIconById(param1);
            if(_loc3_ != null)
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_286[var_621.indexOf(param1)];
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = var_1593.elements("menu");
         var _loc5_:int = 0;
