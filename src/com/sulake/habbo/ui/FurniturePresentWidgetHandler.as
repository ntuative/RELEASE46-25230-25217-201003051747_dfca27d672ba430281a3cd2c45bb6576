package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      private static const const_1065:String = "poster";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_672,RoomWidgetPresentOpenMessage.const_630,RoomWidgetPresentOpenedMessage.const_1205];
      }
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_76:
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_392,0,_container.localization.getKey("inventory.furni.item.landscape.name"),false,null);
                           }
                           ...
                           {
                              if(_loc3_ != null && _loc3_.name == const_1065)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_355:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_387,0,_container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_672:
               ...
               break;
            case RoomWidgetPresentOpenMessage.const_630:
