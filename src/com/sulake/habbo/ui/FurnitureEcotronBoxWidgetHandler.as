package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_645,RoomWidgetEcotronBoxOpenMessage.const_658,RoomWidgetEcotronBoxOpenedMessage.const_1357];
      }
      ...
      {
         return RoomWidgetEnum.const_480;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_645:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_658:
