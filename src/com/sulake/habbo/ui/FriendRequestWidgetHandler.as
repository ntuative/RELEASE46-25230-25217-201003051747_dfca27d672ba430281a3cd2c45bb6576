package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_644);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_569);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_539);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_644:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_569:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_539:
