package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_836:Number = 0;
      
      private var var_484:Point = null;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_483.length)
            {
               _loc2_ = var_483.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_483.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_690.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_283:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_483.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_690.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_583,RoomWidgetChatSelectAvatarMessage.const_605];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_583:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_140,_container.roomSession,0,"Version 25230-25217-201003051718");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_605:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_836 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_836);
            }
            if(var_484 == null)
            {
               var_482.x = 0;
               var_482.y = 0;
               var_482.z = 0;
               var_484 = _loc4_.getScreenPoint(var_482);
               var_836 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_482.x = 0;
            var_482.y = 0;
            var_482.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_482);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_484.x || _loc8_.y != var_484.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_484,_loc5_));
