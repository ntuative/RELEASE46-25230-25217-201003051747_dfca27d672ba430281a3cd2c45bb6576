   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_188 + " " + _loc6_);
            if(var_188 != null && _loc6_ != null)
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_993,HabboToolbarIconEnum.MEMENU);
               _loc8_.bitmapData = _loc6_;
               var_188.events.dispatchEvent(_loc8_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_666,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_444,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_666,onFigureUpdate);
         ...
         if(var_8 != null)
         {
            (var_8 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_876,onAvatarEffectsChanged);
            (var_8 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_933,onHabboClubSubscriptionChanged);
         }
         var_188 = _container.toolbar;
         if(var_188)
         {
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_444,onHelpTutorialEvent);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_619);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_660);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_542);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_632);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_613);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_662);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_617);
         _loc1_.push(RoomWidgetStopEffectMessage.const_636);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1260);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_796);
         _loc1_.push(RoomWidgetToolbarMessage.const_586);
         _loc1_.push(RoomWidgetToolbarMessage.const_641);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_592);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1218);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1003);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_671);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_710);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_634);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_499);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1363);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_679);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_687);
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_629));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_710:
               if(_container != null && false && _container.toolbar.events != null)
               {
                  _loc8_ = new HabboToolbarEvent(HabboToolbarEvent.const_54);
            ...
            case RoomWidgetWaveMessage.const_693:
               ...
               break;
            case RoomWidgetDanceMessage.const_619:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_660:
               if(var_8 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_542:
               if(var_8 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_632:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_617:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_564)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_662:
               ...
               if(var_8 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_914:
                        _catalog.openCatalogPage(CatalogPageName.const_1176,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_947:
                        var_8.toggleInventoryPage(InventoryCategory.const_233);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1301:
                        var_8.toggleInventoryPage(InventoryCategory.const_69);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1356:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_613:
            case RoomWidgetStopEffectMessage.const_636:
            ...
            case RoomWidgetNavigateToRoomMessage.const_796:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_671:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_586:
               ...
               if(var_188)
               {
                  var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_8 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
               ...
               break;
            case RoomWidgetToolbarMessage.const_641:
               ...
               if(var_188 && false)
               {
                  var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_436,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_592:
               ...
               if(_container)
               {
                  ...
                  if(false && _loc23_ == 0)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_466,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_908));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_466,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1268));
                     }
                  }
               ...
               break;
            case RoomWidgetRedeemClubPromoMessage.const_634:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_499:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_679:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_324,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_687:
            ...
            case RoomWidgetAvatarEditorMessage.const_717:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_567));
               }
               break;
            default:
