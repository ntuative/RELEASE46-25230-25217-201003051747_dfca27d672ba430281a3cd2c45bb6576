package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_908:IHabboHelp = null;
      ...
      private var var_763:IRoomWidgetFactory = null;
      ...
      private var var_534:IAvatarRenderManager = null;
      ...
      private var var_166:IToolTipWindow;
      
      private var var_350:ISessionDataManager = null;
      
      private var var_1715:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_458,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_700,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_637 = _roomEngine.loadRoomResources(var_38.roomResources);
            if(false)
            {
               var_1140 = false;
         ...
         {
            var_1141 = !_adManager.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_38.roomId,var_38.roomCategory,var_247[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(var_187 != null)
         {
            ...
            {
               _loc5_ = var_187.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_458,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_700,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_19 = null;
         var_763 = null;
         ...
         if(var_188 && false)
         {
            var_188.events.removeEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            var_188.events.removeEventListener(HabboToolbarEvent.const_54,onHabboToolbarEvent);
         }
         var_188 = null;
         _localization = null;
         _config = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1715);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < var_187.length)
         {
            _loc2_ = var_187.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_188 != null)
         {
            var_167.toolbarSize = var_188.size;
            var_167.toolbarOrientation = var_188.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc3_ == MouseEvent.MOUSE_MOVE && var_166 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(0,15);
            var_166.setGlobalPosition(_loc8_);
         }
      }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_763.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_518:
               ...
               if(var_733 != null && _loc3_ == RoomObjectCategoryEnum.const_34)
               {
                  _loc7_ = var_38.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_410)
                  {
                     var_733.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_235:
               switch(_loc3_)
               {
            ...
            case RoomEngineObjectEvent.const_360:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_197,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            ...
            case RoomEngineObjectEvent.const_114:
               ...
               processWidgetMessage(_loc5_);
               break;
            case RoomEngineObjectEvent.const_348:
            case RoomEngineObjectEvent.const_373:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_187.getWithIndex(_loc2_) as IRoomWidgetHandler;
            if(_loc3_ != null)
            {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_589);
            _loc13_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_517);
            _loc14_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_704);
            _loc15_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_712);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_298);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_416:
               ...
               var_166 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_302,WindowStyle.const_288,WindowParam.const_81) as IToolTipWindow;
               var_166.setParamFlag(WindowParam.const_47,false);
      ...
      {
         if(var_637 == null || false)
         {
            return;
         }
         var _loc2_:int = var_637.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            var_637.splice(_loc2_,1);
         }
         if(false)
         {
            var_1140 = true;
      ...
      {
         if(var_19 != null && var_38 != null && var_1141 && var_1140)
         {
            var_19.startSession(var_38);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_240));
         }
      }
