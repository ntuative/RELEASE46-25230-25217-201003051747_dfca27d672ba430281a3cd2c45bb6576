package com.sulake.habbo.ui
{
   ...
   public class VoteWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionVoteEvent.const_117:
               ...
               break;
            case RoomSessionVoteEvent.const_103:
               _loc3_ = new RoomWidgetVoteUpdateEvent(RoomWidgetVoteUpdateEvent.const_103,_loc2_.question,_loc2_.choices,_loc2_.votes,_loc2_.totalVotes);
         }
         if(_loc3_ == null)
         {
            return;
      ...
      {
         return [RoomWidgetVoteMessage.const_104];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetVoteMessage.const_104:
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(RoomSessionVoteEvent.const_103);
         return _loc1_;
      }
