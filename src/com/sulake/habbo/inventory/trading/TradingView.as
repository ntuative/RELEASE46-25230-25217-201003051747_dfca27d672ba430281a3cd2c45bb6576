package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_780:uint = 4284532064;
      ...
      private var var_353:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_353 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "button_accept":
                  switch(var_22.state)
                  {
                     case TradingModel.const_165:
                        if(var_22.otherUserItems.length == 0 && true)
                        {
                           alertPopup(const_1007);
                        }
                        if(false)
                        {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_983)
            {
            ...
            var_353.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_443);
            var_353.show();
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1555 == null)
         {
            var_1555 = createMinimizedWindow();
         }
         if(!var_2190)
         {
            return var_63;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_63)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_780) : uint(const_781);
            }
         ...
         if(var_63)
         {
            ...
            switch(var_22.state)
            {
               ...
               case TradingModel.const_270:
                  ...
                  showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_426:
                  _loc1_.disable();
                  showInfoMessage("${inventory.trading.info.waiting}");
                  break;
               case TradingModel.const_203:
                  _loc1_.disable();
                  _loc1_.caption = "${inventory.trading.accept}";
                  showInfoMessage("${inventory.trading.info.confirm}");
                  break;
