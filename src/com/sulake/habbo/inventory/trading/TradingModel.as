package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_426:uint = 4;
      
      public static const TRADING_STATE_CANCELLED:uint = 6;
      
      public static const const_270:uint = 3;
      
      public static const const_165:uint = 1;
      
      public static const const_156:uint = 0;
      
      public static const const_1293:uint = 9;
      
      public static const const_203:uint = 5;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_517 = false;
         var_740 = false;
         var_46.updateItemList(var_741);
         var_46.updateItemList(var_1344);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_46.alertPopup(TradingView.const_854);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_741)
            {
               var_517 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_740 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_46.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_741)
            {
               var_46.alertPopup(TradingView.const_974);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_34 + " NEW STATE: " + param1 + " OWN: " + var_517 + " OTHER: " + var_740);
         ...
         {
            case const_156:
               if(param1 == const_165 || param1 == const_203)
               {
                  var_34 = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < var_240.length)
         {
            _loc2_ = var_240.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         else
         {
            ...
            if(var_240.getValue(_loc6_) == null)
            {
               return false;
            }
            _communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
      ...
      public function close() : void
      {
         if(var_609)
         {
            if(var_34 != const_156 && var_34 != const_203)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_156;
            var_8.toggleInventorySubPage(InventorySubCategory.const_920);
            var_609 = false;
         }
         var_46.setMinimized(false);
      }
