package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_952:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_536 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_536.width;
         var_92 = var_536.height;
         var_951 = param5;
         var_754 = param6;
         var_211 = Math.floor(var_951 / _thumbWidth);
         var_17 = new BitmapData(var_951,var_754);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(param1.y < var_447 - 1)
         {
            ...
            var_17.fillRect(new Rectangle(0,0 - var_92,var_17.width,var_92),4294967295);
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(var_17.width,0 - var_92);
               _loc2_ = new Rectangle(0,0,var_17.width,0 - var_92);
               _loc11_.copyPixels(var_17,_loc2_,new Point(0,0),null,null,true);
               var_17 = _loc11_;
               --var_447;
            }
         }
         if(var_17.height < var_754)
         {
            _loc12_ = new BitmapData(var_17.width,var_754);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_536.width,var_536.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_536.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_536,var_536.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_952 != null)
         {
            _loc1_ = var_952.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_447 = resolveRowCountFromList();
         if(var_447 == 0)
         {
            var_17 = new BitmapData(var_951,var_754);
            return;
         }
         var_17 = new BitmapData(Math.max(var_211 * _thumbWidth,var_951),Math.max(var_447 * var_92,var_754),true,16777215);
         var_17.fillRect(var_17.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_447)
         {
            _loc4_ = 0;
            while(_loc4_ < var_211)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     var_17.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * _thumbWidth,_loc3_ * var_92),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_211 && var_17.height < _loc3_.y * var_92)
         {
            _loc2_ = new BitmapData(var_17.width,var_17.height + var_92);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_211 - 1),var_92);
         ...
         _loc2_.copyPixels(var_17,_loc4_,new Point(0,var_92),null,null,true);
         _loc4_ = new Rectangle(0,var_92,_thumbWidth * (var_211 - 1),0 - var_92);
         _loc2_.copyPixels(var_17,_loc4_,new Point(_thumbWidth,var_92),null,null,true);
         var_17 = _loc2_;
      }
