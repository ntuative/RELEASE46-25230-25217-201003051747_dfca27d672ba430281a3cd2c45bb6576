package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IHabboLocalizationManager, param6:ISessionDataManager)
      {
         ...
         var_350 = param6;
         var_350.events.addEventListener(BadgeImageReadyEvent.const_112,onBadgeImageReady);
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_873.length)
         {
            if(var_873[_loc2_] == param1)
            {
      ...
      public function setBadgeSelected(param1:String) : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < var_269.length)
         {
            _loc2_ = var_269[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < var_269.length)
               {
                  if((var_269[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(var_269[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      {
         if(param1 == InventoryCategory.const_233 && false)
         {
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = var_350.getBadgeImage(param1);
            var_269.push(_loc8_);
            if(param2)
            {
