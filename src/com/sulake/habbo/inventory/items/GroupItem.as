package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2255:BitmapData;
      ...
      private const const_1605:int = 8947848;
      
      protected var _items:Map;
      
      protected var _category:int;
      
      protected var var_362:BitmapData;
      
      private const const_1396:Number = 0.2;
      
      protected var var_1363:Boolean;
      
      private const const_1395:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_686)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1433));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1366);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1396;
               _loc1_.blend = const_1396;
            }
            else
            {
               _window.blend = const_1395;
               _loc1_.blend = const_1395;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1363 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2255;
               _loc5_.visible = true;
            }
            else
            {
