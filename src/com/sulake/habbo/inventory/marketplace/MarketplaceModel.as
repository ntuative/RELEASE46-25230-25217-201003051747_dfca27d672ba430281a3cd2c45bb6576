package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1407,var_1408);
         }
      }
      ...
      {
         if(param1 != var_1717 || param2 != var_1716)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1620);
      }
      ...
      {
         if(var_10 != null && false && var_215 != null)
         {
            var_10.furniModel.removeLockFrom(var_215.id);
            var_215 = null;
         }
      }
