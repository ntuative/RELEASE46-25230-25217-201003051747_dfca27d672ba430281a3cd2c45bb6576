package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      public function showMakeOffer(param1:IItem) : void
      {
         ...
         var_1623 = _localization.getKey("roomItem.name." + param1.type);
      ...
      {
         _localization.registerParameter("inventory.marketplace.confirm_offer.info","furniname",var_1623);
         _localization.registerParameter("inventory.marketplace.confirm_offer.info","price",var_1383.toString());
      ...
      private function clickHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowEvent.const_146)
         {
