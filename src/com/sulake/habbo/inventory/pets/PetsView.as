package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_494 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      private function selectFirst() : void
      {
         ...
         setSelectedGridItem(var_580.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_302 != null)
         {
            var_302.setSelected(false);
         }
         var_302 = param1;
         if(var_302 != null)
         {
            var_302.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_302.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_580.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_494.removeGridItem(_loc2_.window);
         if(var_302 == _loc2_)
         {
            var_302 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_580.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_494.addGridItem(_loc2_.window);
            var_580.add(param1.id,_loc2_);
            if(var_302 == null)
            {
               selectFirst();
            }
