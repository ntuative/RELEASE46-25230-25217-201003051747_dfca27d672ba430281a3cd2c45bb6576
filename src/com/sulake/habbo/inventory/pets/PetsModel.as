package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1329 && param1.type == RoomEngineObjectEvent.const_206)
         {
            var_10.showView();
            var_1329 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1329 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_34,RoomObjectTypeEnum.const_283,_loc3_.figure);
            var_10.closeView();
            return;
         }
      ...
      {
         if(var_1075.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
