package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(_view != null)
         {
            var_494 = _view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      
      public function updateItem(param1:int, param2:IWindowContainer) : void
      {
         var _loc3_:IWindow = var_494.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function initFromList() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            var_494.addGridItem(_loc3_.window);
            _loc2_++;
         }
      }
      ...
      {
         var_494.addGridItemAt(param1,param2);
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_49)
         {
            ...
            _model.toggleItemSelection(_category,var_494.getGridItemIndex(param1.window));
            var_347 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_27 && var_347 != null && var_347 == param2 && true)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_89)
         {
            var_347 == null;
         }
         ...
         else if(param1.type == WindowMouseEvent.const_250)
         {
