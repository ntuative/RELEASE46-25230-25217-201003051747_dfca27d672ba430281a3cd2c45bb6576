package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_327:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_206,onObjectPlaced);
         var_496 = new Timer(const_1107,1);
         var_496.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return var_10.getSubCategoryViewId() == InventorySubCategory.const_230;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_410.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_410.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_686)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_206,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_496 != null)
            {
               var_496.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_496.stop();
               var_496 = null;
            }
            if(var_135 != null)
            {
               var_135.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_135.stop();
               var_135 = null;
            }
            if(var_716 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_326)
         {
         ...
         else if(param3 == FurniCategory.const_328)
         {
         ...
         if(var_716 == null)
         {
            var_716 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_716.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_230:
               ...
               break;
            case InventorySubCategory.const_920:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_135 = new Timer(param1,1);
            var_135.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_135.start();
         }
         else
         {
      ...
      {
         var_10.checkCategoryInitilization(InventoryCategory.const_453);
         ...
         if(param1 == InventoryCategory.const_69 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_41:
                  ...
                  break;
               case const_327:
                  var_10.toggleInventoryPage(InventoryCategory.const_166);
            }
         }
      }
      ...
      {
         if(var_867 && param1.type == RoomEngineObjectEvent.const_206)
         {
            var_10.showView();
            var_867 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_328 || _loc3_.category == FurniCategory.const_326 || _loc3_.category == FurniCategory.const_321)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_410 = new Map();
         var_410.add(const_40,new Array());
         var_410.add(const_41,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
