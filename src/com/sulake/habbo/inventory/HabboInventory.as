package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_766:IRoomSession;
      ...
      private const const_1609:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_19 != null)
         {
            var_19.events.removeEventListener(RoomSessionEvent.const_90,roomSessionEventHandler);
            var_19.events.removeEventListener(RoomSessionEvent.const_95,roomSessionEventHandler);
            var_19.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_438,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_95:
               var_766 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_438:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_44.getValue(InventoryCategory.const_665));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_44.getValue(InventoryCategory.const_69));
      }
      ...
      {
         return PetsModel(var_44.getValue(InventoryCategory.const_166));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1609);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_44.getValue(InventoryCategory.const_307));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_230:
               _view.method_1(InventoryCategory.const_69,false);
         }
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_767.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_767.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_44.getValue(InventorySubCategory.const_230));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_350 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_767.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_44.getValue(InventoryCategory.const_453) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_964 = new IncomingMessages(this);
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_90,roomSessionEventHandler);
         var_19.events.addEventListener(RoomSessionEvent.const_95,roomSessionEventHandler);
         var_19.events.addEventListener(RoomSessionPropertyUpdateEvent.const_438,roomSessionEventHandler);
         ...
         var_44.add(InventoryCategory.const_453,_loc3_);
         ...
         var_44.add(InventoryCategory.const_69,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_350);
         ...
         var_44.add(InventoryCategory.const_665,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_350);
         var_44.add(InventoryCategory.const_307,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_44.add(InventorySubCategory.const_230,_loc8_);
         ...
         var_44.add(InventoryCategory.const_166,_loc10_);
