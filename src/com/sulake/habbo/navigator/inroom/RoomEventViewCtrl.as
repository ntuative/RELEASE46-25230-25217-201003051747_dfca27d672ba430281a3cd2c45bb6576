package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_2136:IButtonWindow;
      ...
      private var var_729:TextFieldManager;
      
      private var var_1543:IWindowContainer;
      
      private var var_2137:ITextWindow;
      
      private var var_1318:IButtonWindow;
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_729.getText();
         var _loc6_:Array = new Array();
         addTag(_loc6_,var_897.getText());
         addTag(_loc6_,var_895.getText());
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_1543.visible = true;
         var_2137.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_729.setText(param1.eventDescription);
         var_897.setText(getTagFromEvent(param1,1));
         var_895.setText(getTagFromEvent(param1,2));
         var_1319.visible = false;
         var_1317.visible = true;
         var_1318.visible = true;
         var_1542.visible = false;
         var_1541.visible = true;
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1543 = IWindowContainer(find("event_type_disabled_cont"));
            var_2137 = ITextWindow(find("event_type_disabled_text"));
            var_1542 = ITextWindow(find("create_caption"));
            var_1541 = ITextWindow(find("edit_caption"));
            var_1319 = IButtonWindow(find("create_button"));
            var_1317 = IButtonWindow(find("edit_button"));
            var_2136 = IButtonWindow(find("cancel_button"));
            var_1318 = IButtonWindow(find("end_button"));
            var_896 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1319,onCreateButtonClick);
            Util.setProcDirectly(var_1317,onEditButtonClick);
            Util.setProcDirectly(var_1318,onEndButtonClick);
            Util.setProcDirectly(var_2136,onCancelButtonClick);
            _eventNameInput = new TextFieldManager(_navigator,getInput("event_name"),25);
            var_729 = new TextFieldManager(_navigator,getInput("event_desc"),100);
            var_897 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_895 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_729.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
