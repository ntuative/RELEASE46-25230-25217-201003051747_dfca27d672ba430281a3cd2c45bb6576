package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_898:ISessionDataManager;
      
      private var var_899:RoomCreateViewCtrl;
      
      private var var_1641:RoomThumbnailRenderer;
      ...
      private var var_1039:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_899 = new RoomCreateViewCtrl(this);
         var_1641 = new RoomThumbnailRenderer(this);
         var_1039 = new GuestRoomPasswordInput(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_277.startSearch(Tabs.const_191,Tabs.const_331,param1);
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_898)
         {
            var_898.release(new IIDSessionDataManager());
            var_898 = null;
         }
         if(_catalog)
         {
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_188 != null)
         {
            var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_898 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_277.startSearch(Tabs.const_228,Tabs.const_193);
         var_402.getTab(Tabs.const_228).tabPageDecorator.tabSelected();
      }
