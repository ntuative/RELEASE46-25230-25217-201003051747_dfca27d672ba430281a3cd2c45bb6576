package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1470:CutToHeight = new CutToHeight();
      
      private static var var_1469:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1470.beforeSearch(param2,param1,param3);
         binarySearch(var_1470,param2.length - 1);
      }
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1469.beforeSearch(param2,param1,param3);
         binarySearch(var_1469,param2.length - 1);
      }
   }
}
