package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1641 = new RoomThumbnailRenderer(param1);
         var_794 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_164,var_110.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_794.refreshTags(_loc1_,var_110.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1641.refreshThumbnail(_loc1_,var_110.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_164,var_110);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_164,!true ? getEventCtg(var_110.categoryId) : getRoomCtg(var_110.categoryId));
         refreshRoomDesc(var_164,var_110);
         refreshExtraCont();
         refreshInfo(var_164,"trading_allowed",var_110.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_191,Tabs.const_200,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
