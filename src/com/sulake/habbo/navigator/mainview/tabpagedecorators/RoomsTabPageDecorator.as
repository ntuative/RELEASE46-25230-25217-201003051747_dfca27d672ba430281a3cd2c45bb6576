package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_227,Tabs.const_315);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_227,Tabs.const_515);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_227,Tabs.const_315,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_473 == null)
         {
            var_473 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_473.procedure = onChangeFilter;
