package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1538:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_191,Tabs.const_200,"-1",MainViewCtrl.const_502);
      }
      ...
      private function refreshSearchInfo(param1:IWindowContainer) : void
      {
         ...
         {
            _loc5_.visible = true;
            if(_navigator.data.guestRoomSearchResults.searchType == Tabs.const_331)
            {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1538 == null)
         {
            ...
            var_1538 = new TextSearchInputs(_navigator,false,_loc4_);
            initClearResults(_loc4_);
         }
         var _loc3_:IWindowContainer = param1.getChildByName("search_header") as IWindowContainer;
         if(_navigator.data.guestRoomSearchArrived && _navigator.data.guestRoomSearchResults.searchType == Tabs.const_200)
         {
            var_1538.searchStr.setText(_navigator.data.guestRoomSearchResults.searchParam);
         }
