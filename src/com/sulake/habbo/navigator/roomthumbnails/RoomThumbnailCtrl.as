package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2205:IWindowContainer;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1566,this._model.mode != ThumbnailEditorModel.const_53);
         setEnabled(var_1565,this._model.mode != ThumbnailEditorModel.const_32);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1566 = IButtonWindow(find("top_tab"));
         var_1565 = IButtonWindow(find("obj_tab"));
         var_2205 = IWindowContainer(find("tile_grid"));
         var_2206 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1566,onTopTabButton);
         Util.setProcDirectly(var_1565,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2205;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_455)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_2206;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_56,HabboWindowStyle.const_36,HabboWindowParam.const_66,new Rectangle(0,0,param1.width,66)));
