package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      {
         if(this.var_2204 == null)
         {
            this.var_2204 = this._navigator.getButtonImage(this.var_2203);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_2202 == null)
         {
            ...
            this.var_2202 = new Rectangle(var_1564,var_1564,_loc1_.width - 2 * var_1564,_loc1_.height - 2 * var_1564);
         }
         var_735.bitmap.fillRect(var_735.bitmap.rect,4281545523);
         var_735.bitmap.fillRect(this.var_2202,4284900966);
         copyTo(var_735.bitmap);
         if(_selected)
         {
            var_735.bitmap.copyPixels(var_2201,var_2201.rect,new Point(0,0),null,null,true);
         }
         var_735.invalidate();
      }
