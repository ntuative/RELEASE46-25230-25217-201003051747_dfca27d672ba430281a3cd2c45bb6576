package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_754:int = 32;
      
      private static const const_1067:int = 8;
      
      public static const const_455:int = 10;
      ...
      private var var_814:ThumbnailImageConfigurations;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_814 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_814.getImage(ThumbnailEditorModel.const_32,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1068,_loc4_.y + const_1066 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1899[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_814.getImage(ThumbnailEditorModel.const_35,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_814.getImage(ThumbnailEditorModel.const_35,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_814.getImage(ThumbnailEditorModel.const_53,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_754 / 2);
         return new Point(param1 * const_754 + _loc3_,param2 * const_1067);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         while(_loc3_ <= const_455)
         {
            if(false)
            {
               refreshObj(param1,var_996[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1217 == null)
         {
            var_1217 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1217,var_1217.rect,new Point(0,0),null,null,true);
      }
   }
}
