package com.sulake.habbo.navigator
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_1483:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_navigator.getXmlWindow(this.var_1246));
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_1483[var_1246]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
         ...
         var _loc2_:Rectangle = Util.getLocationRelativeTo(var_266.desktop,var_266.width,var_266.height);
         var_266.x = _loc2_.x;
         var_266.y = _loc2_.y;
         var_1483[var_1246] = var_266;
      }
   }
}
