package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      private var var_905:IProtocolDecoder;
      
      private var var_1070:IProtocolEncoder;
      
      public function WedgieProtocol()
      {
         super();
         var_1070 = new WedgieEncoder();
         var_905 = new WedgieDecoder();
      }
