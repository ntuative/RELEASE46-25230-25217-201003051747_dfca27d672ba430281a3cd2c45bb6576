package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_669:String = "InitConnection";
      ...
      private var var_351:HabboCommunicationDemo;
      ...
      {
         var_351.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_351.shockwaveClientUrl = var_116.shockwaveClientUrl;
         var_351.ssoTicket = var_116.ticket;
         var_116.removeEventListener(SSOTicket.const_303,onParsedTicketSuccess);
         var_116.removeEventListener(SSOTicket.const_268,onParsedTicketFailure);
         var_116 = null;
         dispatchEvent(new Event(const_669));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1413,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_351 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_351.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_457,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_351.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         if(_loc4_ != null)
         {
            _loc4_.addEventListener(WindowMouseEvent.const_89,windowEventProcessor);
         }
         else
         {
            Logger.log("Could not find the button");
         }
         var _loc7_:SharedObject = SharedObject.getLocal(const_1413,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_351.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_351.habboCommunication.habboWebLogin(name,password);
         var_116 = new SSOTicket(var_351.assets,_loc2_,_loc1_);
         var_116.addEventListener(SSOTicket.const_303,onParsedTicketSuccess);
         var_116.addEventListener(SSOTicket.const_268,onParsedTicketFailure);
      }
