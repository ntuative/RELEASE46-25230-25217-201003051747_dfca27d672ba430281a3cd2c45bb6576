package com.sulake.habbo.communication.messages.incoming.users
{
   ...
   public class HabboGroupDetailsMessageEvent extends MessageEvent implements IMessageEvent
   {
      ...
      {
         return (var_4 as HabboGroupDetailsMessageParser).roomName;
      }
      
      public function get groupId() : int
      {
         return (var_4 as HabboGroupDetailsMessageParser).groupId;
      }
      
      public function get name() : String
      {
         return (var_4 as HabboGroupDetailsMessageParser).name;
      }
      
      public function get description() : String
      {
         return (var_4 as HabboGroupDetailsMessageParser).description;
      }
      
      public function get roomId() : int
      {
         return (var_4 as HabboGroupDetailsMessageParser).roomId;
      }
   }
}
