package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_942:int = 0;
      
      public static const const_350:int = -1;
      
      public static const const_322:int = 100;
      ...
      {
         return Math.ceil(this.var_228.length / const_322);
      }
      ...
      {
         if(this.var_833 >= this.getPageCount())
         {
            this.var_833 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_833 + 1) * const_322,this.var_228.length);
      }
