package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1420:String = "no_reqs_info";
       
      
      private var var_1518:IContainerButtonWindow;
      
      private var _friendList:HabboFriendList;
      
      private var var_1519:IContainerButtonWindow;
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_291 && _loc4_.state != FriendRequest.const_332)
            {
               _loc3_.addAcceptedRequest(_loc4_.requestId);
               _loc4_.state = FriendRequest.const_291;
      ...
      {
         var_1518 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1519 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1519.procedure = onDismissAllButtonClick;
         var_1518.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_141)
         {
         ...
         else if(param1.state == FriendRequest.const_291)
         {
         ...
         else if(param1.state == FriendRequest.const_953)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1518,_loc1_);
         setEnabled(var_1519,_loc1_);
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_291;
