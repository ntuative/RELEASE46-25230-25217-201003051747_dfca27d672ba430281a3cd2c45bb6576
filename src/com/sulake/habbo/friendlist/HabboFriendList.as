package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1415:OpenedToWebPopup;
      
      private var var_755:IAvatarRenderManager;
      ...
      private var var_1416:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_773:FriendRequests;
      
      private var var_1729:int;
      
      var var_13:FriendCategories;
      
      private var var_1728:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_774:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1728 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_13 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1416 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_773.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_773.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_402.findTab(FriendListTab.const_83).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_773 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_13.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_13.addCategory(new FriendCategory(FriendCategory.const_942,getText("friendlist.friends")));
         var_13.addCategory(new FriendCategory(FriendCategory.const_350,getText("friendlist.friends.offlinecaption")));
         ...
         if(!var_460)
         {
            var_460 = new Timer(120000);
            var_460.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_460.start();
         }
         getBuddyRequests();
         registerListeners();
         var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_460.stop();
            var_460.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_460 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_127)
         {
            var_127.release(new IIDHabboMessenger());
            var_127 = null;
         }
         if(var_174)
         {
         ...
         if(var_755)
         {
            var_755.release(new IIDAvatarRenderManager());
            var_755 = null;
         }
         if(var_774)
         {
            var_774.release(new IIDHabboNotifications());
            var_774 = null;
         }
         if(var_188)
         {
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_127 = param2 as IHabboMessenger;
      ...
      private function toggleWindow() : void
      {
         ...
         else
         {
            ...
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_295));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1416.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_161,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_773.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      {
         var _loc2_:FriendListTab = var_402.findTab(FriendListTab.const_83);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_755.createAvatarImage(param1,AvatarScaleType.const_100);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_773.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_402.findTab(FriendListTab.const_83);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_755 = param2 as IAvatarRenderManager;
      ...
      {
         var_774 = param2 as IHabboNotifications;
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1415 == null)
         {
            var_1415 = new OpenedToWebPopup(this);
         }
         var_1415.show(x,y);
      }
