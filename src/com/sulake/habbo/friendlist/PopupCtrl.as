package com.sulake.habbo.friendlist
{
   ...
   public class PopupCtrl
   {
      ...
      {
         var_326 = new Timer(500,1);
         var_291 = new Timer(100,1);
         super();
         _friendList = param1;
         var_1246 = param4;
         var_1650 = param2;
      ...
      public function showPopup(param1:IWindowContainer, param2:IWindow) : void
      {
         if(var_48 == null)
         {
            var_48 = IWindowContainer(_friendList.getXmlWindow(var_1246));
         ...
         var_48.x = _loc4_.x - _loc3_.x + var_1650 + param2.width;
