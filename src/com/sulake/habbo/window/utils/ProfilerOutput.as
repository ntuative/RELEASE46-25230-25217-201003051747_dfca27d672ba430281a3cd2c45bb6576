package com.sulake.habbo.window.utils
{
   ...
   public class ProfilerOutput implements IDisposable
   {
      ...
      private var var_720:IWindowRenderer;
      
      private var var_385:IProfiler;
      ...
      public function ProfilerOutput(param1:IProfiler, param2:IHabboWindowManager, param3:IWindowRenderer)
      {
         ...
         var_385.addStopEventListener(refresh);
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_510)
            {
               var_1190 = false;
               ITextWindow(_window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = var_385.getProfilerAgentsInArray();
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            _window.dispose();
            _window = null;
            var_385.removeStopEventListener(refresh);
            var_385 = null;
            _windowManager = null;
            var_720 = null;
            _disposed = true;
