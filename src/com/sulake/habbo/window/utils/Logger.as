package com.sulake.habbo.window.utils
{
   ...
   public class Logger extends Component implements ILogger
   {
      ...
      private var var_1386:ICoreWindowManager;
      ...
      {
         var_1386 = param2 as ICoreWindowManager;
         _window = var_1386.create("Logger::Output",HabboWindowType.const_457,WindowStyle.const_288,0 | 0 | 0 | 0,new Rectangle(0,0,180,240),loggerEventProc,"Logger") as IFrameWindow;
         var_321 = var_1386.create("Logger::Output::Text",HabboWindowType.const_1,WindowStyle.const_288,0 | 0 | 0,new Rectangle(0,0,_window.content.width,_window.content.height),null,"") as ITextWindow;
