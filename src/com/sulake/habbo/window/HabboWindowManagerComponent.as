package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1301:ProfilerAgentTask;
      
      private var var_1302:IEventDispatcher;
      
      private var var_2375:uint = 0;
      
      private var var_1303:ProfilerAgentTask;
      
      private var var_1304:ProfilerOutput;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1302 = Component(param1).events;
         var_416 = new Array();
      ...
      {
         return var_234[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_234[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_720 = new WindowRenderer(_loc4_);
         var_234 = new Array(const_343);
         var _loc6_:int = 0;
         while(_loc6_ < const_343)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_720,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_234[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_210 = var_234[const_1113];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_210.getMouseCursor().defineCustomCursorType(MouseCursorType.const_318,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_210.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1216,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_234[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_234.pop()).dispose();
            }
            var_234 = null;
            while(false)
            {
      ...
      {
         return var_234[param1].getDesktopWindow().getChildAt(var_210.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1304 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1304 = new ProfilerOutput(_loc3_,this,var_720);
               var_1301 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1301);
               var_1303 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1303);
               var_1047 = true;
            }
         }
      }
      ...
      {
         return var_210.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_920.length > 0)
         {
            var_1302.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_343 - 1;
            while(_loc2_ >= 0)
            {
               var_234[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_1047)
         ...
         var_1302.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_343)
         {
            var_234[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_1047)
         {
         ...
         if(WindowContext.var_920.length > 0)
         {
            WindowContext.var_920.flush();
         }
         if(WindowContext.var_1358.length > 0)
         {
            WindowContext.var_1358.flush();
         }
         var_1302.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_416[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_416[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_210.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1175,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1332,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1239,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1134,param2.name + ": " + param2.toString());
            }
         }
      }
   }
