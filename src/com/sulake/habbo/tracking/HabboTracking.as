package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_756:uint = 11;
      ...
      private var var_396:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_1005:int = -1;
      
      private var var_1236:LagWarningLogger = null;
      
      private var var_828:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1236 = new LagWarningLogger();
         var_1235 = new Array(const_756);
         var _loc4_:int = 0;
         while(_loc4_ < const_756)
         {
            var_1235[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1158,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1353,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_676,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_812,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1313);
               break;
            case HabboCommunicationEvent.const_590:
               trackLoginStep(HabboLoginTrackingStep.const_1151,String(_communication.port));
               break;
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_295:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_174)
         {
            Component(var_174).events.addEventListener(HabboConfigurationEvent.const_169,onConfigurationLoaded);
            if(var_224 != null)
            {
               var_224.configuration = var_174;
            }
            if(var_225 != null)
            {
               var_225.configuration = var_174;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _adManager.events.addEventListener(AdEvent.const_481,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_812,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_676,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_590,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_501,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_61,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_475,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_467:
               var_1236.registerWarning(LagWarningLogger.const_840);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_828)
            {
               var_828.release(new IIDHabboWindowManager());
               var_828 = null;
            }
            if(_adManager)
            {
            ...
            if(var_173)
            {
               if(true)
               {
                  ...
                  Component(var_173).events.removeEventListener(HabboFriendListTrackingEvent.const_295,onFriendlistTrackingEvent);
               }
            ...
            if(var_396)
            {
               if(true)
               {
                  var_396.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_396.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_396.release(new IIDHabboHelp());
               var_396 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_467,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_174)
         {
            Component(var_174).events.removeEventListener(HabboConfigurationEvent.const_169,onConfigurationLoaded);
         }
      }
      ...
      {
         var_396 = param2 as IHabboHelp;
         var_396.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_396.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_965);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_965,onCoreRunning);
         }
      }
      ...
      {
         var_828 = IHabboWindowManager(param2);
         if(var_828)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_467,onLagWarningEvent);
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_173).events.addEventListener(HabboFriendListTrackingEvent.const_295,onFriendlistTrackingEvent);
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_501)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1331);
         }
         else if(param1.type == HabboHotelViewEvent.const_475)
         {
