package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_916:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_481,0,0,_loc4_,var_1572,var_916,var_915));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         ...
         var_1573 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1341 = _loc2_.imageUrl;
         var_1572 = _loc2_.clickUrl;
         if(var_1341 != "" && var_1572 != "")
         {
            _loc3_ = var_1341;
            ...
            _loc4_ = new URLRequest(var_1341);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_473,0,0,param1.bitmapData,var_2216));
            var_739 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_915 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1573 > 0 && var_1574 >= var_1573)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_739;
         if(_loc1_ > var_2215)
         {
            ++var_1574;
      ...
      {
         var_292 = param2 as IHabboCommunicationManager;
         if(var_292 == null)
         {
            return;
         }
         _connection = var_292.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_406));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_916 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
