package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         var_1676 = param1.petRace;
         _image = param1.image;
         var_1677 = param1.isOwnPet;
         var_1673 = param1.ownerId;
         _ownerName = param1.ownerName;
         _canOwnerBeKicked = param1.canOwnerBeKicked;
         var_1630 = param1.level;
         var_1675 = param1.levelMax;
         var_1669 = param1.experience;
         var_1671 = param1.experienceMax;
         _energy = param1.energy;
         var_1678 = param1.energyMax;
         _nutrition = param1.nutrition;
         var_1670 = param1.nutritionMax;
         _petRespect = param1.petRespect;
         var_1674 = param1.roomIndex;
         var_1672 = param1.age;
      }
