package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1624:String = "nutrition";
      ...
      private const const_1627:int = 158;
      
      private const const_1630:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_273:PetCommandTool;
      
      private const const_1628:uint = 11184810;
      
      private const const_1625:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_220 != null)
         {
            var_102 = var_220.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_102 == null || var_220 == null || var_60 == null)
         {
            return;
         }
         ...
         var_220.height = NaN;
         _window.width = Math.max(var_220.width,var_60.width);
      ...
      private function openTrainView() : void
      {
         if(var_273 == null)
         {
            var_273 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1300.getValue(var_713) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_273.showWindow(true);
            var_273.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         updateStateElement(const_1625,param1.experience,param1.experienceMax);
         updateStateElement(const_1631,param1.energy,param1.energyMax);
         updateStateElement(const_1624,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_713 = param1.id;
         var_1300.remove(param1.id);
         var_1300.add(param1.id,param1);
         if(var_273 && var_273.isVisible() && param1.isOwnPet)
         {
            var_273.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_273.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_408,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1627,const_1630,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1628);
