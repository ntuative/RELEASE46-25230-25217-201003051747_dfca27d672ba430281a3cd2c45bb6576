package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      {
         var _loc2_:* = null;
         if(var_1349 != null && var_1349.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_913 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_913 += param1.height + const_1635;
            return fit(param1);
         }
         param1.offset(_offsetX,var_913);
         _offsetX += param1.width + const_1636;
         return true;
      }
