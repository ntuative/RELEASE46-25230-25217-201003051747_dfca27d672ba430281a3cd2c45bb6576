package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_719[var_1038] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_304)
         {
            ...
            var_304 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_304.center();
            var_304.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1038;
         if(var_1038 < var_719.length)
         {
            _loc1_ = var_719[var_1038] as Dictionary;
            if(!_loc1_)
            {
