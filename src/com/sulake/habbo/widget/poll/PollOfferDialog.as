package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_231:String = "POLL_OFFER_STATE_UNKNOWN";
      
      public static const const_621:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_1279:String = "POLL_OFFER_STATE_OK";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     var_34 = const_1279;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_593,_id));
                     break;
                  case "poll_offer_button_cancel":
                     var_34 = const_621;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_376,_id));
