package com.sulake.habbo.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         {
            var_2276 = (param1 as CoreComponent).assets;
         }
      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_282:
               _loc2_ = new RoomChatWidget(_windowManager,_assets,_localizations,var_98,var_1805++,this);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               _loc2_ = new RoomChatInputWidget(_windowManager,_assets,_localizations,this);
               break;
            case RoomWidgetEnum.const_425:
               _loc2_ = new InfostandWidget(_windowManager,_assets,_localizations,var_98);
               break;
            case RoomWidgetEnum.const_479:
               _loc2_ = new MeMenuWidget(_windowManager,_assets,_localizations,_events,var_98);
               break;
            ...
            case RoomWidgetEnum.const_454:
               _loc2_ = new LoadingBarWidget(_windowManager,_assets,_localizations,var_98);
               break;
            case RoomWidgetEnum.const_563:
               _loc2_ = new RoomQueueWidget(_windowManager,_assets,_localizations,var_98);
               break;
            case RoomWidgetEnum.const_104:
               _loc2_ = new VoteWidget(_windowManager,_assets,_localizations,var_98);
               break;
