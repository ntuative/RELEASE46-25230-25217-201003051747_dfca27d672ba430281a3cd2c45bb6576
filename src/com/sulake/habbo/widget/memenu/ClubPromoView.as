package com.sulake.habbo.widget.memenu
{
   ...
   public class ClubPromoView
   {
      ...
      public static const const_359:String = "CPV_MODE_TRIAL";
      
      public static const const_1379:String = "CPV_MODE_FULL";
      ...
      public function ClubPromoView(param1:MeMenuWidget, param2:String = "", param3:String = "CPV_MODE_FULL")
      {
         ...
         if(!setPromoImage() && param2 != "")
         {
            ...
            _loc8_.addEventListener(AssetLoaderEvent.const_29,onPromoImageReady);
         }
         if(param3 == const_359)
         {
      ...
      private function onRedeem(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = new RoomWidgetRedeemClubPromoMessage(RoomWidgetRedeemClubPromoMessage.const_634,_loc2_.text,var_738 == const_359);
