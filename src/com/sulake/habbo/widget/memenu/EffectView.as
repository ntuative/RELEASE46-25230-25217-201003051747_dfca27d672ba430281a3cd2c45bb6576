package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_821:IWindow;
      
      private var var_371:Number;
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(var_820 != null)
         {
            if(false)
            {
               _loc2_ = 0 / Number(var_172.duration);
               var_820.width = _loc2_ * var_371;
            }
            else
            {
               var_820.width = 0;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_821 = _window.findChildByName("effect_hilite");
            var_821.visible = false;
         }
         var_822 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_820 = _window.findChildByName("loader_bar");
         if(var_820 != null)
         {
            var_371 = var_820.width;
            var_178.start();
            onUpdate();
         }
         if(false)
         {
            setElementBitmap("effect_icon",var_172.icon);
         }
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_822 != null)
         {
            var_822.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_822.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
