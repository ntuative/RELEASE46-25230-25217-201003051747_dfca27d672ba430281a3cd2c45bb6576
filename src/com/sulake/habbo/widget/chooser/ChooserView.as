package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1407:uint = 0;
      ...
      {
         var _loc2_:* = null;
         if(_itemList == null || param1 < 0 || param1 > _itemList.numListItems || param1 == var_657)
         {
            return;
         }
         if(var_657 != -1)
         {
            _loc2_ = _itemList.getListItemAt(var_657) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_657 % 2) ? uint(const_1407) : uint(const_1408);
            }
         }
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(const_1407) : uint(const_1408);
