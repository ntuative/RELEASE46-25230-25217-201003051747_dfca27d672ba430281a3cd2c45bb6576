package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1033:Number = 100;
      
      private static const const_1034:Number = 100;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_387,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_369,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_392,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_387,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_369,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_392,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomWidgetPresentDataUpdateEvent.const_369:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_392:
               if(!var_218)
               {
                  return;
               }
            ...
            case RoomWidgetPresentDataUpdateEvent.const_448:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_387:
               if(!var_218)
               {
                  return;
               }
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_630,var_148);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_56,HabboWindowStyle.const_36,0 | 0,new Rectangle(const_1033,const_1034,2,2),null,0) as IWindowContainer;
