package com.sulake.habbo.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1036:int = 500;
      
      private static const const_1033:Number = 100;
      
      private static const const_1035:int = 14;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetStickieDataUpdateEvent.const_582,onObjectUpdate);
      ...
      private function sendSetColor(param1:uint) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_439,var_148,var_190,var_628);
      ...
      private function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_554,var_148);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetStickieDataUpdateEvent.const_582,onObjectUpdate);
      }
      ...
      private function sendUpdate() : void
      {
         ...
         if(messageListener != null)
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_439,var_148,var_190,var_628);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function showInterface() : void
      {
         ...
         if(_window == null)
         {
            _window = windowManager.createWindow("stickieui_container","",HabboWindowType.const_56,HabboWindowStyle.const_36,0 | 0,new Rectangle(const_1033,const_1034,2,2),null,0) as IWindowContainer;
         ...
         {
            _loc3_.text = var_190;
            _loc3_.addEventListener(WindowEvent.const_146,onTextWindowEvent);
         }
         ...
         setColorButtons(var_10 && var_1393 == "post_it");
      }
      ...
      private function onTextWindowEvent(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1036;
         if(_loc2_.numLines < const_1035)
         {
            return;
         }
