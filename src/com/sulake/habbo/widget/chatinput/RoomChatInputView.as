package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1400:int = 5;
      
      private static const const_490:int = 16;
      ...
      private var var_371:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_970 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1734 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1735 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_645 = new Timer(1000,1);
         var_645.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_775 = new Timer(5000,1);
         var_775.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowEvent.const_146,onInputChanged);
         _window.addEventListener(WindowEvent.const_375,onWindowMoved);
         var_1148 = true;
         var_123 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1736 = _loc2_.width + const_490 + _loc6_.width + const_1053;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1054,_loc8_.width) + const_490);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_970 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_123 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_371);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_371);
         }
