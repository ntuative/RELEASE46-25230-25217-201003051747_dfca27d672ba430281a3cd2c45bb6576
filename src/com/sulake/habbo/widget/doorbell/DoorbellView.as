package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellView
   {
      ...
      public function createMainWindow() : void
      {
         ...
         var_51 = (_doorbell.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(var_51 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
         var_47 = var_51.findChildByName("user_list") as IItemListWindow;
         var_51.visible = false;
         var _loc2_:IWindow = var_51.findChildByTag("close");
         if(_loc2_ != null)
         {
