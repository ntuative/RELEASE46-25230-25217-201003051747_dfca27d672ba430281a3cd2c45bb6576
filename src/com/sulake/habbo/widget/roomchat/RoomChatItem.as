package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_490:int = 6;
      
      private static const const_339:int = 10;
      
      private static const const_1055:Number = 18;
      
      private static const const_1403:Number = 10;
      
      private static const const_1404:Number = 8;
      ...
      private var var_191:BitmapData;
      
      private var var_975:uint;
      ...
      {
         _widget.onItemMouseOut(var_977,var_976,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_977,var_976,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1155 = param1.chatType;
         var_977 = param1.userId;
         var_782 = param1.userName;
         var_976 = param1.userCategory;
         _message = param1.text;
         var_1156 = param1.userX;
         var_191 = param1.userImage;
         var_975 = param1.userColor;
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_89,onBubbleMouseUp);
         }
      }
      ...
      public function renderView() : void
      {
         ...
         switch(var_1155)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_265:
               ...
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_239:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         if(var_191 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_191.height);
         }
         ...
         if(var_191 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_191.width;
               _loc28_.height = var_191.height;
               _loc28_.bitmap = new BitmapData(var_191.width,var_191.height,true,0);
               _loc28_.bitmap.copyPixels(var_191,var_191.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_377 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_191.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_975 != 0)
            {
               _loc30_ = uint(var_975 >> 16 & 255);
               _loc31_ = uint(var_975 >> 8 & 255);
               _loc32_ = uint(var_975 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1155 == RoomWidgetChatUpdateEvent.const_265)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_782);
            }
            else if(var_1155 == RoomWidgetChatUpdateEvent.const_239)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_782);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_377;
            _loc20_.width = _loc20_.textWidth + const_490;
            _width += _loc20_.textWidth + const_490;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_339 + _loc20_.textWidth + const_490;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_977,var_976,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_977,var_976,_roomId,_roomCategory,param1);
      }
