package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1071:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_154.state = RoomChatHistoryPulldown.const_207;
         ...
         var_42 = param2.createWindow("chatscroller","",HabboWindowType.const_956,HabboWindowStyle.const_39,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_223 > 0 && param2)
         {
            if(var_1222)
            {
               if(Math.abs(param1 - var_223) <= const_1005)
               {
                  return;
               }
               var_1222 = false;
            ...
            if(var_296)
            {
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(var_42.scrollV < 1 - const_1071 / var_42.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1468)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_296 && !var_1322)
         {
            ...
            var_154.state = RoomChatHistoryPulldown.const_284;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_154.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_207);
      }
