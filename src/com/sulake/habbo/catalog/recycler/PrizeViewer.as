package com.sulake.habbo.catalog.recycler
{
   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         var_267.bitmap = new BitmapData(var_267.width,var_267.height,true,16777215);
         var_267.bitmap.fillRect(var_267.bitmap.rect,16777215);
         var _loc2_:Point = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
         var_267.bitmap.copyPixels(param1,param1.rect,_loc2_,null,null,true);
      }
      ...
      {
         var _loc8_:* = null;
         var_267 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {
