package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_751:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1444)
         {
            case RecyclerStatusMessageEvent.const_1221:
               var_253 = const_340;
               if(_view == null)
               {
                  return;
            ...
            case RecyclerStatusMessageEvent.const_994:
               ...
               break;
            case RecyclerStatusMessageEvent.const_1318:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return active && var_253 == const_340;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_858:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1163:
