package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1407:uint = 4.294967295E9;
      
      private const const_1408:uint = 4.293848814E9;
      ...
      private const const_1607:int = 10;
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_761;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_761,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1408) : uint(const_1407);
      }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = var_1398;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = _catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_77);
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_678,var_80,var_957);
               dispose();
               break;
            case "cancel_button":
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_761);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_542[var_185]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_541[var_186]);
         _catalog.purchaseProductAsGift(var_678,var_80,var_957,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_146:
               ...
               if(var_1690 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in var_228)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= const_1607)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1690 = _loc3_.text;
               break;
            case WindowMouseEvent.const_49:
               showSuggestions(false);
               if(var_1136)
               ...
               break;
            case WindowKeyboardEvent.const_708:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1398 = _loc1_.stuffTypes;
            var_542 = _loc1_.boxTypes;
            var_541 = _loc1_.ribbonTypes;
            var_761 = var_1398[0];
            var_185 = var_542[0];
            var_186 = var_541[0];
            initColorGrid();
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_450 == null)
         {
            var_450 = createWindow("suggestion_list_item") as IWindowContainer;
            var_450.procedure = suggestionsEventHandler;
         }
         if(var_213 == null || var_450 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_213.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_450.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
