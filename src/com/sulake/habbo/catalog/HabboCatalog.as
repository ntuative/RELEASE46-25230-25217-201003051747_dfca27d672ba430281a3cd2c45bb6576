package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_309:CatalogViewer;
      
      private var var_2131:Boolean = true;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_419:ICatalogNavigator;
      ...
      private var var_2130:GiftWrappingConfiguration;
      ...
      private var var_1057:ClubGiftController;
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2129 && var_507 != null)
         {
            var_507.playSound(HabboSoundTypesEnum.const_810);
         }
         var_2129 = false;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_90:
               var_1314 = param1.session.isPrivateRoom;
               if(var_88 != null)
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2130 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_188.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1057.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_419 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createClubGiftController() : void
      {
         if(var_1057 == null)
         {
            var_1057 = new ClubGiftController(this);
         }
      }
      ...
      {
         var_188.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_419.buildCatalogIndex(_loc2_);
         if(var_1058 != "")
         {
            var_419.openPage(var_1058);
            var_1058 = "";
         }
         else
         {
      ...
      {
         if(param1 == null || var_309 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_309.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_309.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2131 && var_507 != null)
         {
            var_507.playSound(HabboSoundTypesEnum.const_1018);
         }
         var_2131 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_309.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_309.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_309 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_309.habboCatalog = this;
      }
