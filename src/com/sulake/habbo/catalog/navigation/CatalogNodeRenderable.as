package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1032:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1390:XML;
      
      private static var var_1391:XML;
       
      
      private var var_2277:IWindowContainer;
      ...
      private var var_1389:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1389 == 4294967295)
            {
               var_1389 = _loc1_.color;
            }
            _loc1_.color = const_1032;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1265;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1390) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_47 = navigator.catalog.windowManager.buildFromXML(var_1391) as IItemListWindow;
         if(var_47 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1153;
            }
         }
      }
