package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1461:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_678 != null)
         {
            _container.removeChild(var_678.window);
            var_678.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1461);
         var_678 = _loc5_;
      ...
      {
         return var_678.dispatchWidgetEvent(param1);
      }
