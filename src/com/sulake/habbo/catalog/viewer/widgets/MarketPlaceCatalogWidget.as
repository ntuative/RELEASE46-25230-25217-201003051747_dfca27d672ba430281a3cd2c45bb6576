package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_863:MarketPlaceOfferData;
      
      private const const_1419:int = 1;
      
      private const const_1622:int = 40;
      
      private var var_495:IWindowContainer;
      
      private const const_1418:int = 2;
      ...
      private const const_1621:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_495)
         {
            ...
            var_495 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_495)
         {
            return;
         ...
         updateStatusDisplay(const_1418,_loc2_.length);
         if(!var_408)
         {
            var_408 = new Timer(25);
            var_408.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_864 = 0;
         populateList();
         var_408.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_585)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_495 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_495.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1419);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_409.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_408)
         {
            var_408.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_408 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_864 >= var_585.length)
            {
               return true;
            }
            addListItem(var_585.getWithIndex(var_864));
            ++var_864;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_863.offerId);
            }
            return;
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_146)
         {
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_409));
            _loc7_.selection = 0;
         }
      }
