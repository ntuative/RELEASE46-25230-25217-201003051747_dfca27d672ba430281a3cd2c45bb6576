package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_590[var_1046] as Array;
      ...
      {
         var _loc2_:Offer = var_590[var_1046][var_2108];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_435 || _loc1_.pricingModel == Offer.const_419)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_76 || _loc3_.productType == ProductTypeEnum.const_77)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_1045.indexOf(_loc5_) == -1)
                        {
                           var_1045.push(_loc5_);
                           var_590.push(new Array());
                        }
                        _loc6_ = var_1045.indexOf(_loc5_);
                        (var_590[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1046 = var_928.getGridItemIndex(param1.view);
