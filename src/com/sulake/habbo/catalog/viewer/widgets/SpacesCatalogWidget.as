package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1187:String = "IWindowFocusManagerService";
      
      private var var_1313:Array;
      
      private var var_1055:BitmapData = null;
      
      private var var_236:int = 0;
      
      private var var_727:int = 0;
      
      private var var_1188:String = "1.1";
      ...
      private var var_1056:BitmapData = null;
      ...
      private var _floorType:String = "IWindowFocusManagerService";
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_1055 != null && var_1056 != null)
         {
            setRoomImage(var_1055,var_1056);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_174.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[var_276];
               if(_loc11_ != null)
               {
         ...
         for each(_loc1_ in var_174.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[var_275];
               if(_loc13_ != null)
               {
                  var_1188 = _loc13_.@id;
               }
         ...
         switch(param1)
         {
            case const_178:
               ...
               for each(_loc8_ in var_174.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_725 = _loc8_.children().length();
                  }
               }
            ...
            case const_177:
               ...
               for each(_loc10_ in var_174.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_727 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1187);
               }
               break;
            ...
            case "ctlg_buy_landscape":
               _loc3_ = var_1312[var_308];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1188);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1187,var_1188,64,this,"window_romantic_wide");
