package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1267:IScrollbarWindow;
      
      protected var var_1364:XML;
      
      private var var_1266:BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_582 != null)
         {
            var_582.visible = false;
            var_582.destroyGridItems();
         }
         if(var_1267 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1284.text = "${" + _loc3_.name + "}";
            var_1283.text = "${" + _loc3_.description + "}";
         }
         else
         {
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_403:
                  _loc4_ = var_1266.clone();
                  if(var_582 != null)
                  {
                     var_582.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_582,var_1267,var_1364);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_223:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_278,AvatarAction.const_731);
                              _loc13_.appendAction(AvatarAction.const_585,_loc6_.productClassId);
      ...
      {
         var_1284 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1283 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_85 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1506 = new Point(var_85.x,var_85.y);
         var_582 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1267 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_582 == null)
         {
         ...
         var_1266 = _loc2_.content as BitmapData;
