package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:Map = var_428.getWithIndex(var_205);
         if(_loc2_ != null)
         {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         var_85.bitmap.copyPixels(param1,param1.rect,_loc2_,null,null,true);
         var_85.invalidate();
      }
      ...
      override public function init() : void
      {
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(var_428.getValue(_loc6_) == null)
            {
               var_428.add(_loc6_,new Map());
            }
            _loc8_ = var_428.getValue(_loc6_) as Map;
            _loc8_.add(_loc7_,_loc3_);
         }
         _loc4_ = var_428.getWithIndex(var_205);
         if(_loc4_ != null)
         {
