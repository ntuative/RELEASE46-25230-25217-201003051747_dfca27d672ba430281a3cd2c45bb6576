package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_842:PrizeViewer;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_697.length)
         {
            createLevelItem(var_697[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_842 = new PrizeViewer();
         var_585 = new Map();
         var_697 = recycler.getPrizeTable();
         if(var_697 == null)
         {
            return;
         }
         ...
         var_1972 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_697[0].prizes.length > 0)
         {
            select(var_697[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1972) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_842.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
