package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_963:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_962 != null)
         {
            var_962.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_963 != null)
         {
            var_963.removeEventListener(WindowKeyboardEvent.const_150,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_962 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_962 != null)
         {
            var_962.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_963 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_963 != null)
         {
            var_963.addEventListener(WindowKeyboardEvent.const_150,windowKeyEventProcessor);
         }
      }
