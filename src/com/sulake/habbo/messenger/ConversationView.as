package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1070:int = 10;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_127 = param1;
         var_1466 = initButton("follow_friend",onFollowButtonClick,param2);
         var_47 = IItemListWindow(param2.findChildByName("msg_list"));
         var_1901 = IScrollbarWindow(param2.findChildByName("scroller"));
         var_127.refreshButton(param2,"close",true,onCloseButtonClick,0);
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(var_127.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_663 || param3.type == Message.const_573 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_479.messages.length - const_755);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_479.messages.length)
         {
            refreshEntry(true,_loc1_,var_479.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      {
         var _loc1_:Conversation = var_127.conversations.findSelectedConversation();
         if(_loc1_ == null)
         {
            return;
         }
         if(var_479 == null || _loc1_.id != var_479.id)
         {
            var_479 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_755 + const_1069)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_127.conversations.closeConversation();
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_127.send(new FollowFriendMessageComposer(var_479.id));
      }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = var_127.getButtonImage(param1);
      ...
      {
         if(param1 == Message.const_663)
         {
            return 4294967295;
         }
         if(param1 == Message.const_573)
         {
            return 4292801535;
         }
         if(param1 == Message.const_884)
         {
            return 4294927974;
         }
         if(param1 == Message.const_528)
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(var_127.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            var_127.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1070;
         param1.invalidate();
      }
   }
}
