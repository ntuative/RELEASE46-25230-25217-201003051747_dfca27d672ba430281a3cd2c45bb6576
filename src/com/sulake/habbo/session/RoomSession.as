package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_999:UserDataManager;
      ...
      {
         if(var_34 == RoomSessionEvent.const_281 && _connection != null)
         {
            var_34 = RoomSessionEvent.const_90;
            if(isPrivateRoom)
            {
      ...
      {
         return var_999 as IUserDataManager;
      }
