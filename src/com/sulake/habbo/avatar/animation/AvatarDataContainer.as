package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1086:Map;
      
      private var var_1413:Number = 1;
      
      private var _b:uint;
      
      private var var_1410:Number = 1;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1412,var_1410,var_1413,_alphaMultiplier);
         var_1086 = generatePaletteMapForGrayscale(var_2241,var_2243);
      }
      
      public function get reds() : Array
      {
         return var_1086.getValue("reds") as Array;
      }
      ...
      {
         return var_1086.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1086.getValue("greens") as Array;
      }
      ...
      {
         return var_1086.getValue("alphas") as Array;
      }
