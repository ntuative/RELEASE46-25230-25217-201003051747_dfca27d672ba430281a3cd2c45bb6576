package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1411:int = 60000;
      ...
      private var var_787:IAvatarImage;
      ...
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         ...
         var _loc2_:AvatarImageBodyPartCache = var_130.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            var_130.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_610)
               {
                  _loc6_ = _loc15_.action;
                  _loc4_ = _loc8_;
               }
               else if(_loc15_.type == AnimationLayerData.const_351)
               {
                  _loc4_ = _loc8_;
               }
               _loc7_ = true;
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_69.getParts(param1,(var_787 as AvatarImage).getFigure(),_loc6_,var_1221,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_69.getCanvas(var_183,var_1221);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1224[param1])
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_889 || _loc32_ == AvatarAction.const_600) && (_loc6_ == AvatarBodyPartType.const_296 || _loc6_ == AvatarBodyPartType.const_1219 || _loc6_ == AvatarBodyPartType.const_1312) && _loc7_.color != null)
               {
         ...
         if(_loc20_)
         {
            if(var_183 == AvatarScaleType.const_51)
            {
               _loc30_.x += 67;
            }
            else
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         if(var_130 != null)
         {
            _loc2_ = var_130.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc4_ = var_130.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc4_ != null)
               {
