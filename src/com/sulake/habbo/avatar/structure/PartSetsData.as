package com.sulake.habbo.avatar.structure
{
   ...
   public class PartSetsData implements IStructureData
   {
      ...
      {
         return var_571[param1] as PartDefinition;
      }
      
      public function getActiveParts(param1:IActionDefinition) : Array
      {
         var _loc2_:ActivePartSet = var_818[param1.activePartSet];
         if(_loc2_ != null)
         {
            return _loc2_.parts;
         }
      ...
      public function addPartDefinition(param1:XML) : PartDefinition
      {
         ...
         if(true)
         {
            var_571[_loc2_] = new PartDefinition(param1);
         }
         return var_571[_loc2_];
      }
      ...
      public function parse(param1:XML) : Boolean
      {
         ...
         {
            var_571[String(_loc2_["set-type"])] = new PartDefinition(_loc2_);
         }
         for each(_loc3_ in param1.activePartSet)
         {
            var_818[String(_loc3_.@id)] = new ActivePartSet(_loc3_);
         }
         return true;
      }
      ...
      {
         return var_818[param1.activePartSet] as ActivePartSet;
      }
