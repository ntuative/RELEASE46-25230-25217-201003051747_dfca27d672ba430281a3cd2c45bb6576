package com.sulake.habbo.avatar.structure.figure
{
   public class FigurePartSet implements IFigurePartSet
   {
      ...
      public function FigurePartSet(param1:XML)
      {
         ...
         var_947 = String(param1.@gender);
         var_1662 = parseInt(param1.@club);
         var_1664 = Boolean(parseInt(param1.@colorable));
         ...
         for each(_loc2_ in param1.part)
         {
            ...
            if(_loc5_ != -1)
            {
               var_571.splice(_loc5_,0,_loc4_);
            }
            else
            {
               var_571.push(_loc4_);
         ...
         {
            var_1394.push(String(_loc3_.@parttype));
         }
      }
      ...
      private function indexOfPartType(param1:FigurePart) : int
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < var_571.length)
         {
            _loc3_ = var_571[_loc2_];
