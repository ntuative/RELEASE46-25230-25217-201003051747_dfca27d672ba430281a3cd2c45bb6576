package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_533:AvatarEditorHandler;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_629.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_1121)
         {
            ...
            var_445["null"] = new FigureData(this);
            var_445["null"] = new FigureData(this);
            _loc1_ = var_445["null"];
            _loc2_ = var_445["null"];
            ...
            var_13 = new Map();
            var_13.add(AvatarEditorCategory.const_864,new GenericModel(this));
            var_13.add(AvatarEditorCategory.const_44,new HeadModel(this));
            var_13.add(AvatarEditorCategory.const_296,new TorsoModel(this));
            var_13.add(AvatarEditorCategory.const_1209,new LegsModel(this));
            var_13.add(AvatarEditorCategory.const_904,new WardrobeModel(this));
            var_1121 = true;
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_533 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_948 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc14_.isSelectable && (_loc13_ || var_948 >= _loc14_.clubLevel))
               {
            ...
            if(_loc8_)
            {
               ...
               if(_loc19_)
               {
                  ...
                  _loc6_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1359.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc21_ = false;
               if(_loc5_.gender == FigureData.const_1140)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc5_.isSelectable && _loc21_ && (_loc16_ || var_948 >= _loc5_.clubLevel))
               {
                  _loc6_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1359.clone() as IWindowContainer,param1,_loc5_,_loc12_,_loc15_);
                  _loc3_.push(_loc6_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_13.getValue(AvatarEditorCategory.const_904);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_629.getPalette(param1);
      }
      ...
      {
         var_629 = var_534.getFigureData(AvatarType.const_85);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_534 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_210 == null)
            {
               var_210 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_56,HabboWindowStyle.const_36,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_210.addChild(_view.window);
               var_210.center();
               var_210.visible = false;
            }
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_864);
         if(var_533 != null)
         {
            var_533.getWardrobe();
         }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_948 = param3;
         var _loc4_:FigureData = var_445[param2];
         if(_loc4_ == null)
         {
            return;
         }
