package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_685:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_640.width,var_640.height,true,0);
            _loc1_.bitmap.copyPixels(var_640,var_640.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_831.width,var_831.height,true,0);
            _loc4_ = var_831.clone();
            _loc4_.colorTransform(_loc4_.rect,var_685.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_684.width,var_684.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_684,var_684.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(false)
               {
                  _loc5_.bitmap.copyPixels(var_1011,var_1011.rect,new Point(0,0),null,null,true);
               }
               else
               {
                  _loc5_.bitmap.copyPixels(var_1010,var_1010.rect,new Point(0,0),null,null,true);
               }
            }
         }
      }
