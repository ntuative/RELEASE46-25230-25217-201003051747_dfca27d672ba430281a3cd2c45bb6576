   ...
   public class CategoryBaseView
   {
      ...
      protected function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result && result.length)
         {
            ...
            {
               bmpWindow.bitmap = new BitmapData(bmpWindow.width,bmpWindow.height,false,AvatarEditorView.var_2251);
      ...
      protected function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_36[var_283];
         if(_loc2_ == null)
         {
            return;
         }
