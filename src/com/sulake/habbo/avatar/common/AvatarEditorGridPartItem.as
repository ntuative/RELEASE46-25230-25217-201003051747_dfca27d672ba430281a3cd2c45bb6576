package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem
   {
      ...
      private var var_565:IFigurePartSet;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         var_1011 = _loc6_.content as BitmapData;
         if(param3 == null)
         {
            var_362 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc8_ = param3.parts;
            ...
            {
               var_1458 = Math.max(var_1458,_loc7_.colorLayerIndex);
            }
         }
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(var_565 != null && false)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               _loc6_.bitmap.copyPixels(var_1011,var_1011.rect,new Point(0,0),null,null,true);
            }
         }
         if(isSelected)
         {
      ...
      private function analyzeLayers() : Boolean
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_928 + "_" + FigureData.const_238;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(var_811.width,var_811.height,true,16777215);
         var _loc6_:Array = partSet.parts.concat().sort(sortByDrawOrder);
         for each(_loc2_ in _loc6_)
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_928 + "_" + FigureData.const_238;
            ...
            if(_loc4_ != null)
            {
               ...
               if(var_1457 && _loc2_.colorLayerIndex > 0)
               {
