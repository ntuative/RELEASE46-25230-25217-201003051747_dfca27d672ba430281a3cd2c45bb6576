package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseModel
   {
      ...
      protected var var_13:Map;
      
      protected var var_10:HabboAvatarEditor;
      ...
      public function stripClubItemsOverLevel(param1:int) : void
      {
         ...
         var _loc2_:Array = var_13.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = _loc2_[_loc3_];
            _loc5_ = var_13[_loc4_];
            _loc6_ = false;
            ...
            if(_loc6_)
            {
               ...
               if(_loc7_ && var_10 && false && _loc5_)
               {
                  var_10.figureData.savePartData(_loc4_,_loc7_.id,_loc5_.getCurrentColorIds(),true);
               }
            }
            _loc3_++;
         }
