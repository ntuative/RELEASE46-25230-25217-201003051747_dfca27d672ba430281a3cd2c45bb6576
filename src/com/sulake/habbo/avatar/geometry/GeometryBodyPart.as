package com.sulake.habbo.avatar.geometry
{
   ...
   public class GeometryBodyPart extends Node3D
   {
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in var_571)
         {
            if(_loc1_ != null)
            {
               if(_loc1_.isDynamic)
               {
                  var_571[_loc1_.id] = null;
                  _loc1_ = null;
               }
            }
         }
      ...
      {
         var _loc2_:Number = Math.abs(param1.z - this.transformedLocation.z - var_1331);
         var _loc3_:Number = Math.abs(param1.z - this.transformedLocation.z + var_1331);
         return Math.min(_loc2_,_loc3_);
      }
      
      public function hasPart(param1:String) : Boolean
      {
         var _loc2_:GeometryItem = var_571[param1];
         return _loc2_ != null;
      }
