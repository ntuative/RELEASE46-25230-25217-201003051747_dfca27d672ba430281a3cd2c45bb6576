package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_452:Matrix4x4;
      
      private var var_770:Vector3D;
      
      private var var_120:Dictionary;
      
      private var var_643:Dictionary;
      
      private var var_1409:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_770 = new Vector3D(0,0,10,0);
         super();
         var_452 = new Matrix4x4();
         var_643 = new Dictionary();
         var_1409 = new AvatarSet(param1.avatarset[0]);
         ...
         for each(_loc4_ in param1.type)
         {
            ...
            var_643[String(_loc4_.@id)] = _loc12_;
         }
      }
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(hasBodyPart(param1,param2))
         {
            ...
            var_452 = var_452.identity().rotateY(param3);
            return _loc5_.getParts(var_452,var_770,param4);
         }
         return [];
      }
      ...
      {
         var _loc2_:AvatarSet = var_1409.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = var_643[param1] as Dictionary;
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:IActionDefinition) : Array
      {
         ...
         var_452 = var_452.identity().rotateY(param2);
         for each(_loc8_ in _loc6_)
         {
            _loc8_.applyTransform(var_452);
            _loc11_ = _loc8_.getDistance(var_770);
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(typeExists(param1))
         {
            return var_643[param1] as Dictionary;
         }
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = var_1409.findAvatarSet(param1);
         if(_loc3_ != null)
         {
