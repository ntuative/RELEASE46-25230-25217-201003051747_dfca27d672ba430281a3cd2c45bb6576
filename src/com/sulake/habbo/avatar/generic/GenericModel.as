package com.sulake.habbo.avatar.generic
{
   ...
   public class GenericModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public function toggleItemSelection(param1:String, param2:int) : void
      {
         ...
         var_10.figureData.savePartData(FigureData.const_57,_loc4_.id,_loc3_.getCurrentColorIds(),true);
      ...
      private function init() : void
      {
         ...
         var_13 = new Map();
         var_13["null"] = var_10.generateDataContent(this,FigureData.const_57);
      ...
      public function categorySwitch(param1:String) : void
      {
         ...
         switch(param1)
         {
            case FigureData.const_75:
               var_10.gender = FigureData.const_75;
               break;
      ...
      public function toggleColorSelection(param1:String, param2:int) : void
      {
         ...
         var_10.figureData.savePartSetColourId(FigureData.const_57,_loc3_.getCurrentColorIds(),true);
         updateView();
      }
      ...
      private function updateCategoryData(param1:String) : void
      {
         ...
         var _loc2_:int = var_10.figureData.getPartSetId(FigureData.const_57);
         var _loc3_:Array = var_10.figureData.getColourIds(FigureData.const_57);
