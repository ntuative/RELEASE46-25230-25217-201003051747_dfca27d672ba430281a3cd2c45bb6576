package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_368:PartSetsData;
      
      private var var_1608:PartOffsetData;
      
      private var var_749:AvatarActionManager;
      
      private var var_145:IAssetLibrary;
      
      private var var_2276:IAssetLibrary;
      
      private var var_1375:Boolean = false;
      
      private var var_1609:AvatarRenderManager;
      
      private var var_438:FigureData;
      ...
      private var var_1379:AvatarStructureDownloadSet;
      
      private var var_622:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_145 = param2;
         var_2276 = param3;
         var_438 = new FigureData();
         var_368 = new PartSetsData();
         _animationData = new AnimationData();
         var_1379 = new AvatarStructureDownloadSet();
         var_622 = new AnimationManager();
         var_623 = param4;
         var_1608 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_749.getActionDefinitionWithState(param1);
      }
      ...
      private function init() : void
      {
         ...
         switch(var_623)
         {
            case AvatarType.const_85:
               _loc1_ = var_145.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_368.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_145.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_145.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_438.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_145.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_368.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_145.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_145.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_438.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_749.getCanvasOffsets(param1,param2,param3);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_749.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_622.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_368.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_368.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1271[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_749.getDefaultActionType();
         var _loc7_:Array = var_368.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_622.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_438.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_438.getPalette(_loc23_.paletteID);
               if(_loc24_)
               {
                  ...
                  if(_loc25_ != null)
                  {
                     ...
                     for each(_loc26_ in _loc25_.parts)
                     {
                        if(_loc9_.indexOf(_loc26_.type) > -1)
                        {
                           ...
                           _loc13_ = var_368.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc35_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_368.getPartDefinition(_loc11_);
                     _loc37_ = false;
                     _loc38_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_85:
               if(var_145.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_145.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_145.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_145.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_623 + " ready to go!");
         if(var_623 == AvatarType.const_85)
         {
            var_368.getPartDefinition("ri").appendToFigure = true;
            var_368.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_85:
               var_1379.add(new AvatarStructureDownload(var_145,_loc5_,var_438));
               break;
            case AvatarType.PET:
         }
         var_1379.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_622.getAnimation(param1);
      }
      ...
      {
         var_749 = new AvatarActionManager(var_145,var_623);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_145.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_145.getAssetByName("dance" + _loc1_).content as XML;
            var_622.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_145.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_145.getAssetByName("fx" + _loc1_).content as XML;
            var_622.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_438.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_438.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_749.sortActions(param1);
      }
   }
}
