package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorHandler
   {
      ...
      public function saveCurrentSelection() : void
      {
         ...
         var _loc1_:String = var_10.figureData.getFigureString();
         var _loc2_:String = var_10.figureData.gender;
      ...
      private function onWardrobe(param1:WardrobeMessageEvent) : void
      {
         ...
         var_10.wardrobe.updateMyLooks(param1.state,param1.outfits);
      }
