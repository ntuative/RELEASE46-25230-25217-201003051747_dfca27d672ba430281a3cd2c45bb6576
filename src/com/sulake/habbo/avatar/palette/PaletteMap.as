package com.sulake.habbo.avatar.palette
{
   ...
   public class PaletteMap
   {
      ...
      {
         param1.paletteMap(param1,param1.rect,new Point(0,0),_blank,var_444,_blank,_blank);
      }
      ...
      public function colorize(param1:ByteArray) : ByteArray
      {
         ...
         while(param1.bytesAvailable >= 4)
         {
            ...
            _loc7_ = uint(var_444[_loc5_] as uint);
      ...
      {
         var _loc2_:int = var_444.indexOf(param1);
