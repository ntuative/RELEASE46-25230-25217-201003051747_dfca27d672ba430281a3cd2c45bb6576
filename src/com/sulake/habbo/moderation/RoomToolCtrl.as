package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1029:ICheckBoxWindow;
      ...
      private var var_1028:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_49.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),var_49,WindowTracker.const_545,_data.flatId),var_51,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_415);
         if(param1.flatId != var_415)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_415);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var_49.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1371,_loc2_,var_405.text,"",""));
         if(false)
         {
            var_49.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1029.isSelected,var_1028.isSelected,var_707.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1324);
      }
      ...
      public function populate() : void
      {
         ...
         var_707 = ICheckBoxWindow(var_51.findChildByName("kick_check"));
         var_1029 = ICheckBoxWindow(var_51.findChildByName("lock_check"));
         var_1028 = ICheckBoxWindow(var_51.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         var_49.connection.send(new GetModeratorRoomInfoMessageComposer(var_415));
         Logger.log("BEGINNING TO SHOW: " + var_415);
      }
   }
}
