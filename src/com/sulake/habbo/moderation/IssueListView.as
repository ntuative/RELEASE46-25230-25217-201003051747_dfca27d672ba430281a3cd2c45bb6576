package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_2363:BitmapData;
      
      private var var_2364:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         var_47 = param3;
         var_1113 = param4;
         var_1471 = var_591.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || var_1471 == null)
            {
               return;
            }
            _loc2_ = var_1471.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
            ...
            if(_loc7_ != null)
            {
               ...
               _loc9_ = var_591.assets.getAssetByName(_loc8_) as BitmapDataAsset;
