package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1616:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1618:String = "picked_issues";
      ...
      private const const_1617:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_232:ITabContextWindow;
      
      private var var_1494:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_342.view.width = var_232.container.width;
         var_342.view.height = var_232.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1617:
               if(var_1493 == null)
               {
                  var_1493 = new MyIssuesView(issueManager,this,var_232.container);
               }
               return var_1493;
            case const_1616:
               if(var_1492 == null)
               {
                  var_1492 = new OpenIssuesView(issueManager,this,var_232.container);
               }
               return var_1492;
            case const_1618:
               if(var_1494 == null)
               {
                  var_1494 = new PickedIssuesView(issueManager,this,var_232.container);
               }
               return var_1494;
            default:
               return null;
