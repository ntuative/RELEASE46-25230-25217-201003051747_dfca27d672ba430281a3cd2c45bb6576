package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_427:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_59.issueManager.releaseBundle(var_117.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_427 = new UserInfoCtrl(_window,var_59,_loc3_.message);
         var_1084 = new UserInfoCtrl(_window,var_59,_loc3_.message);
         var_427.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_117.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1084.load(_loc4_,var_117.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_59.issueManager.closeBundle(var_117.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_59.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_59,WindowTracker.const_905,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_59 != null && false && var_117 != null)
         {
            var_59.issueManager.removeHandler(var_117.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_427 = new UserInfoCtrl(_window,var_59,_loc3_.message);
            var_427.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_59.issueManager.closeBundle(var_117.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_59.issueManager.closeBundle(var_117.id,3);
         checkAutoHandling();
         dispose();
      }
