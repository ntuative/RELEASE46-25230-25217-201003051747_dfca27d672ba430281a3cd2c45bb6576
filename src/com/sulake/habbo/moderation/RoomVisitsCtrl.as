package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1849.clone());
         ...
         new OpenRoomTool(var_51,var_49,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
      ...
      {
         var_1849 = IWindowContainer(var_49.getXmlWindow("roomvisits_row"));
         ...
         var_51 = IFrameWindow(var_49.getXmlWindow("roomvisits_frame"));
         var_47 = IItemListWindow(var_51.findChildByName("visits_list"));
      ...
      {
         return WindowTracker.const_1266;
      }
   }
}
