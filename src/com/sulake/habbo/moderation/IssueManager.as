package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_696:String = "issue_bundle_my";
      
      public static const const_1014:String = "issue_bundle_picked";
      ...
      private var var_591:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_136 = new Map();
         var_891 = new Map();
         var_591 = new IssueBrowser(this,var_59.windowManager,var_59.assets);
         var_728 = [];
         var_892 = [];
         var_1059 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_1059.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
         ...
         for each(_loc4_ in var_136)
         {
            switch(param1)
            {
               case const_950:
                  ...
                  break;
               case const_696:
                  if(_loc4_.state == IssueMessageData.const_476 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_728 = var_728.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_891.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_891.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1342)
         {
            var_159.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_136)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_891.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_891.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_141)
         {
            ...
            _loc8_ = var_892.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_1059.remove(param1);
         var_1059.add(param1,_loc3_);
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_476 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      {
         var _loc2_:* = var_1059.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_591 == null || !var_591.isOpen())
         {
            var_59.soundManager.playSound(HabboSoundTypesEnum.const_1000);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_891.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_136.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_476 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
