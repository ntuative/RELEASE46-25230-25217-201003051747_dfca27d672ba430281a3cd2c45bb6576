package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1266:int = 6;
      
      public static const const_545:int = 4;
      ...
      public static const const_1171:int = 8;
      
      public static const const_946:int = 5;
      ...
      {
         var _loc2_:Dictionary = var_1473[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1473[param1] = _loc2_;
         }
         return _loc2_;
      }
