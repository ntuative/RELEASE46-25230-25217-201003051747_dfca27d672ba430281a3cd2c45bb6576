package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1448:IMessageComposer;
      ...
      {
         var_866 = IWindowContainer(var_49.getXmlWindow("chatlog_roomheader"));
         var_865 = IWindowContainer(var_49.getXmlWindow("chatlog_chatline"));
         var_383 = new Timer(300,1);
         var_383.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_51 = IFrameWindow(var_49.getXmlWindow("chatlog_frame"));
         var_47 = IItemListWindow(var_51.findChildByName("chatline_list"));
         var_51.procedure = onWindow;
         var _loc1_:IWindow = var_51.findChildByTag("close");
         _loc1_.procedure = onClose;
         var_49.connection.send(var_1448);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_866.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_51,var_49,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
      ...
      {
         if(param1.type != WindowEvent.const_43 || param2 != var_51)
         {
            return;
         }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_865.clone());
         _loc4_.color = var_1280[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_51,var_49,_loc6_,param2.chatterId);
         }
