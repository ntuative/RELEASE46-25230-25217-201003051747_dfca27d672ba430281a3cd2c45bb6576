package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl implements IDisposable
   {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_49.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!var_1165 ? 0 : 1,_roomId),var_49,WindowTracker.const_545,_roomId),var_51,false,false,true);
      }
      ...
      private function onRoomToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_49.windowTracker.show(new RoomToolCtrl(var_49,_roomId),var_51,false,false,true);
      }
      ...
      public function show() : void
      {
         if(var_51 == null)
         {
            var_51 = IFrameWindow(var_49.getXmlWindow("start_panel"));
            ...
            var_51.findChildByName("room_tool_but").disable();
            var_51.findChildByName("chatlog_but").disable();
            var_49.disableButton(var_49.initMsg.cfhPermission,var_51,"ticket_queue_but");
