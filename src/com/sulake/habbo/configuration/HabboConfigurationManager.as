package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private static var var_1562:String = "%";
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1197);
      }
      
      public function keyExists(param1:String) : Boolean
      {
         var _loc2_:String = var_1074[param1] as String;
         return _loc2_ != null;
      }
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         if(var_1563.indexOf(param1) < 0)
         {
            var_1074[param1] = param2;
         }
      }
      ...
      {
         var _loc4_:String = var_1074[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_2200);
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1562);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1562,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
