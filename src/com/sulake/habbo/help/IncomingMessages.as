package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_29.tellUI(HabboHelpViewEnum.const_195,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_29.tellUI(HabboHelpViewEnum.const_264,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_29.tellUI(HabboHelpViewEnum.const_144);
      }
      ...
      {
         var_29.showUI(HabboHelpViewEnum.const_305);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_29.showUI(HabboHelpViewEnum.const_420);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_29.showUI(HabboHelpViewEnum.const_503);
         var_29.tellUI(HabboHelpViewEnum.const_503,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_410)
            {
         ...
         var_29.tellUI(HabboHelpViewEnum.const_575);
      }
