package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_660:FaqCategory;
      ...
      {
         super();
         var_659 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_660 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_126 = new Map();
      }
      
      public function getCategory(param1:int, param2:String = null, param3:Boolean = false) : FaqCategory
      {
         var _loc4_:FaqCategory = var_126.getValue(param1);
      ...
      {
         var _loc4_:* = null;
         if(var_659.hasItem(param1))
         {
            var_659.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_660.hasItem(param1))
         {
            var_660.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
         while(_loc3_ < var_126.length)
         {
            _loc4_ = var_126.getWithIndex(_loc3_);
      ...
      public function dispose() : void
      {
         ...
         if(var_126 != null)
         {
            ...
            {
               _loc2_ = var_126.getWithIndex(_loc1_);
               _loc2_.dispose();
               _loc1_++;
            }
            var_126.dispose();
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(var_660.hasItem(param1))
         {
            return var_660.getItem(param1);
         }
         var _loc2_:int = 0;
         while(_loc2_ < var_126.length)
         {
            _loc3_ = var_126.getWithIndex(_loc2_);
